...
function set_template_influencer($influencer_mensaje, $nombre_docente,$nombre_estudiante,$identificacion){
return <<<MESSAGE
    ...
    <div style='max-width:425px; padding:2%; margin:auto'>
        ...
        <div style='background-color: #fff'>
            ...
            <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                <tr>
                    <td align='center'>
                    <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡¡ INFLUENCER SOMOS TODOS!!</b></font>
                    </td>
                </tr>
                    
                <tr >
                    <td style='text-align: left; '>
                        <p style="margin: 0; line-height: 36px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 22px; font-style: normal; font-weight: bold; color: #333333;">
                            $nombre_estudiante
                        </p>
                ...
                <tr>
                    <td>
                        ...
                        <p
                            ...
                            font-size: 16px;
                            ">
                            Reporte:<br> <strong>$influencer_mensaje</strong>
                        </p>  
            ...
            <table width='100%' border='0' align='center'>
                <tr>
                    ...
                    <p
                        ...
                        "
                    >
                    Docente: <strong>$nombre_docente</strong>
                    </p>
