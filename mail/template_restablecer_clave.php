...
function set_template_restablecer_clave($correo_electronico, $nueva_clave){
return <<<MESSAGE
    ...
    <div style='max-width:425px; padding:2%; margin:auto'>
        <div style='background-color: #fff'>
            ...
            <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                <tr>
                    <td align='center'>
                    <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡Restablecimiento de contraseña!</b></font>
                    </td>
                </tr>
                <tr >
                    <td style='text-align: left; '>
                        <h1 style="margin: 0; line-height: 36px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 17px; font-style: normal; font-weight: bold; color: #333333;">
                            Se ha restablecido correctamente tu contraseña
                        </h1>
                    </td>
                </tr>
                <tr>
                    <td> 
                        <p style=" margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 24px; color: #999999; font-size: 16px;">
                            Usuario : <strong>$correo_electronico</strong> <br><br>
                            Contraseña: <strong>$nueva_clave</strong>  
                        </p>    
                    </td>
                </tr>
            </table>
...
//echo set_template_restablecer_clave("David Gonzelz", "10000000000", "13123123123");
?>