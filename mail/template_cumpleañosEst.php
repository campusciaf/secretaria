<?php
function set_template_cumpleañosEst($credencial_nombre){
return <<<MESSAGE
    ...
    <div style='max-width:425px; padding:2%; margin:auto'>
        <div style='background-color: #fff'>
            ...
            <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                ...
                <tr>
                <center>
                                <img src='http://localhost/campus-virtual/mail/recursos/cumple_est.png' width="285px"><br> <br>
            ...
            <tr bgcolor='#001550'>
                <td style="padding-left: 30px;">
                    <a href='https://es-la.facebook.com/ComunidadCIAF/' target='_blank'><img
                            src='https://www.ciaf.edu.co/mercadeo/imagenes/r_face.png'></a>
                    <a href='https://twitter.com/ComunidadCIAF' target='_blank'><img
                            src='https://www.ciaf.edu.co/mercadeo/imagenes/r_twitter.png'></a>
                    <a href='https://www.youtube.com/channel/UCgaRVYt3yzzlhbLZ1vhxCUQ' target='_blank'><img
                            src='https://www.ciaf.edu.co/mercadeo/imagenes/r_youtube.png'></a>
                    <a href='https://www.ciaf.edu.co/inicio.php' target='_blank'><img
                            src='https://www.ciaf.edu.co/mercadeo/imagenes/r_www.png'></a>
                    <br>
                </td>
                <td>
                    <p
...
//echo set_template_cumpleañosEst("camila londoño quintero");
?>
