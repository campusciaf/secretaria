...
function set_template($mensaje, $fecha_solicitud,$newhora,$asunto_caso,$asunto_caso_opcion ){
return <<<MESSAGE
...
<div style='max-width:425px; padding:2%; margin:auto'>
    ...
    <div style='background-color: #fff'>
        ...
        <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
            <tr>
                <td align='center'>
                <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡¡ Casos PQRS sin atender !!</b></font>
                </td>
            </tr>
        ...
        <table width='100%' border='0' align='center'>
            ...
            <tr>
                ...
                "
            >
            Fecha solicitud: <strong>$fecha_solicitud a las $newhora</strong>
            </p>  
