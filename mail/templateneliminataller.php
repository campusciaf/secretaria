...
function set_template_elimina_taller($nombre_ejercicios){
return <<<MESSAGE
    ...
    <div style='max-width:425px; padding:2%; margin:auto'>
        <div style='background-color: #fff'>
            ...
            <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                <tr>
                    <td align='center'>
                    <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡Se ha rechazado el taller: $nombre_ejercicios!</b></font>
                    </td>
                </tr>
...
// echo set_template_elimina_taller("prueba taller");
