<?php
function set_template_cumpleaños_egre($credencial_nombre){
return <<<MESSAGE
        ...
        <div style='max-width:425px; padding:2%; margin:auto'>
            <div style='background-color: #fff'>
                <table width='100%' border='0'>
                    <tr style="background-image: url(https://ciaf.digital/tareas_cron/bg-bienestar.webp)">
                        <td>
                            <center>
                                <br>
                                <img src='http://ciaf.digital/public/img/logo.webp' width="150px">
                                <br><br>
                            </center>
                        </td>
                    </tr>
                ...
                <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                    <tr>
                        <td align='center'>
                            <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡Mensaje Importante!</b></font>
                        </td>
                    </tr>
                    <tr>
                                <center>
                                    <img src='https://ciaf.digital/mail/recursos/cumple_egre.png' width="285px"><br><br>
                                </center>
                ...
                <tr bgcolor='#001550'>
                    <td style="padding-left: 30px;">
                        <a href='https://es-la.facebook.com/ComunidadCIAF/' target='_blank'>
                            <img src='https://www.ciaf.edu.co/mercadeo/imagenes/r_face.png'>
                        </a>
                        <a href='https://twitter.com/ComunidadCIAF' target='_blank'>
                            <img src='https://www.ciaf.edu.co/mercadeo/imagenes/r_twitter.png'>
                        </a>
                        <a href='https://www.youtube.com/channel/UCgaRVYt3yzzlhbLZ1vhxCUQ' target='_blank'>
                            <img src='https://www.ciaf.edu.co/mercadeo/imagenes/r_youtube.png'>
                        </a>
                        <a href='https://www.ciaf.edu.co/inicio.php' target='_blank'>
                            <img src='https://www.ciaf.edu.co/mercadeo/imagenes/r_www.png'>
                        </a>
                        <br>
                    </td>
                    <td>
                        <p style=" margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 21px; color: #333333; font-size: 14px;">
                            <a target="_blank" href="https://ciaf.edu.co" style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; text-decoration: none; color: #efefef; font-size: 14px;">
                                www.ciaf.edu.co
                            </a>
                        </p>
                    </td>
...
//echo set_template_cumpleaños_egre("Camila Londoño Quintero");
?>