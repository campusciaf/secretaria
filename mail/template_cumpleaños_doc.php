<?php
function set_template_cumpleaños_doc($usuario_nombre){
return <<<MESSAGE
        ...
        <div style='max-width:425px; padding:2%; margin:auto'>
            <div style='background-color: #fff'>
                ...
                <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
                    ...
                    <tr > 
                            <center> <img src='https://ciaf.digital/mail/recursos/cumple_doc.png' width="285px"><br><br></center>
...
//echo set_template_cumpleaños_doc("Camila Londoño Quintero");
?>