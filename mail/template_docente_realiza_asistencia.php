<?php
function reporte_template_asisntecia_docente($contenidotabla)
{
return <<<MESSAGE
<div style='background-color: #fff; max-width:600px; padding:2%; margin:auto'>
    ...
    <div style='color: #001550; font-family: Oswald, sans-serif; font-size: 20px; font-weight: 900; padding-left:2rem;'>
        Reporte Docentes que NO realizaron Asistencia
    </div>
    <p style='font-family: Oswald, sans-serif; font-size: 15px; color: #333; padding: 1rem 4rem; text-align: justify;'>
        Cordial Saludo,<br><br>
        
        A continuación se muestra el listado de docentes que tenían clase hoy y no realizaron la asistencia en el campus virtual.

    </p>
    <table border='1' cellpadding='5' cellspacing='0' style='margin: 10px auto; border-collapse: collapse; width: 100%;'>
        <thead>
