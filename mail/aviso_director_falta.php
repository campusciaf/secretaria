...
function set_template($programa,$nombre_materia,$numerofaltas,$motivo_falta,$fecha,$identificacion,$nombre,$docente){
return <<<MESSAGE
...
<div style='max-width:425px; padding:2%; margin:auto'>
    ...
    <div style='background-color: #fff'>
        ...
        <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'>
            <tr>
                <td align='center'>
                <font size='4px' color='#064789' face='Arial, Helvetica, sans-serif'><b>¡¡ Faltas acumuladas !!</b></font>
                </td>
            </tr>
                
            <tr >
                <td style='text-align: left; '>
                    <h1 style='margin: 0; line-height: 24px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 20px; font-style: normal; font-weight: bold; color: #333333;'>
                        $programa 
                    </h1>
                    <h2 style='margin: 0; line-height: 24px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; color:#064789;'>
                        Total faltas: $numerofaltas faltas reportadas
                    </h2>
                    <h3 style='margin: 0; line-height: 24px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; color:#064789;'>
            ...
            <tr>
                ...
                '
            >
            Ultima falta reportada: <strong>$fecha</strong><br>
            Motivo falta: <strong>$motivo_falta</strong><br>
            Estudiante: <strong>$nombre</strong><br>
            Identificación: <strong>$identificacion</strong>
            </p> 
            <p style="font-size:24px">Docente: $docente</p> 
