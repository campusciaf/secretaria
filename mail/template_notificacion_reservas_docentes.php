...
function set_template_notificacion_reservas_docentes($hora, $hasta, $codigo_salon, $nombre_docente, $correo_docente, $telefono_docente, $programa_final, $asistentes_final, $materia_evento, $experiencia_nombre, $experiencia_objetivo, $duracion_horas, $requerimientos, $requerimientos_otro, $novedad, $fecha_reserva){
return <<<MESSAGE
