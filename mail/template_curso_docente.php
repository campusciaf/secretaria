...
function template_curso_docente( $usuario_nombre)
{
    ...
    <div style='background-color: #fff'>
        <div style='max-width:600px; padding:2%; margin:auto'>
            <div style='background-color: #fff'>
                ...
                <table width='100%' cellpadding='10' cellspacing='0' align='center' border='0' bgcolor='#fff'> <td align='center' style='color: #001550; margin: 0; line-height: 36px; font-family: Oswald, sans-serif; font-size: 20px; font-weight: 900; font-style: italic; padding-left:2rem;'> ¡Felicidades $usuario_nombre!</td></tr>
                    <tr>
                        <td style='text-align: left; padding:0'>
                            <p style="margin: 0; line-height: 24px; mso-line-height-rule: exactly; font-family: Oswald, sans-serif; font-size: 15px; font-style: normal; color: #333333; padding: 1rem 4rem; transform: scaleY(1.1); text-align: justify"> ¡Has finalizado con éxito el curso Domina el campus virtual! Gracias por tu participación y compromiso en cada una de las actividades propuestas. ¡Esperamos que hayas disfrutado de la experiencia y que hayas adquirido nuevos conocimientos que te permitan seguir brindando experiencias en tu aula de clase, Nos vemos en próximos aprendizajes!
                            </p>
...
//echo template_curso_docente("Luis Ariosto Serna");
