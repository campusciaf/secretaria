...
?>
					...
					<div class="row mb-2">
						<div class="col-xl-8 col-9">
							<h2 class="m-0 line-height-16">
								...
								<span class="fs-14 f-montserrat-regular">Cartera vencidad, esta es la meta del semestre</span>
							</h2>
						</div>
	...
	<?php
        ...
        require 'footer.php';
	?>
	<script src="scripts/sofi_metas.js?<?= date("y-m-d") ?>"></script>
