...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    $submenu = 3904;
    require 'header.php';
    if ($_SESSION['reporte_hoja_vida'] == 1) {
?>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="card card-primary" style="padding: 2%">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="table_datos" style="padding-top: 10px;">
                                                <table class="table table-striped compact table-sm table-responsive" id="dtl_funcionarios_hoja_vida">
                                                    <thead>
                                                        <tr>
    ...
    require 'footer.php';
        ?>
        <script type="text/javascript" src="scripts/reporte_hoja_vida.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
    <?php
}
ob_end_flush();
    ?>