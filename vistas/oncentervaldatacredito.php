...
if (!isset($_SESSION["usuario_nombre"])) {
	...
	$submenu = 1429;
	require 'header.php';
	if ($_SESSION['oncentervaldatacredito'] == 1) {
?>
					...
					<div class="row mb-2">
						<div class="col-xl-6 col-9">
							<h2 class="m-0 line-height-16">
								<span class="titulo-2 fs-18 text-semibold">Data Crédito </span><br>
						...
						<div class="col-12 migas">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">DataCredito</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-auto">
										<div class="col-12 fs-14 line-height-18">
											...
											<span class="text-semibold fs-20">DataCredito</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-12 table-responsive p-4" id="listadoregistros">
								<table id="tbllistado" class="table table-hover" style="width:100%">
									<thead>
										...
										<th id="t-jornada"> Datacredito </th>
								...
								<form class="col-12" action="#" id="formularioDatacredito" method="post">
									<div class="form-group mb-3 position-relative check-valid">
										<div class="form-floating">
											<input type="hidden" id="id_interesado" name="id_interesado">
											<input type="hidden" id="primer_apellido_datacredito" name="primer_apellido_datacredito">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-success">
						<h6 class="modal-title" id="modal_whatsapp_label"> Whatsapp </h6>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					</div>
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/oncentervaldatacredito.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
