                    ...
                    <div class="row mb-2">
                        <div class="col-xl-6 col-9">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Inscripción</span><br>
                ...
                <div class="row">
                    <section class="container-fluid px-4">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card table-responsive p-4" id="listadoregistros">
                                    <table id="tbllistado" class="table table-hover" style="width:100%">
                                        <thead>
                                            ...
                                            <th id="t-jo">Jornada</th>
                                            <th id="t-re">Recibo</th>
                                            <th id="t-val">Validar</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="resultado_cambiar_documento">
                        <form name="formularioeditarperfil" id="formularioeditarperfil" method="POST">
                            ...
                            <br><br>
                            <input type="submit" value="Guardar Cambios" id="btnEditar"
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/oncentervalinscripcion.js?<?= date("Y-m-d H:i:s")?>"></script>
