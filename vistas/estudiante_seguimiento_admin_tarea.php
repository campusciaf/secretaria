...
if (!isset($_SESSION["usuario_nombre"])) {
   ...
   if ($_SESSION['egresadosseguimientoadmintarea'] == 1) {
?>
               ...
               <div class="row mb-2">
                  <div class="col-xl-6 col-9">
                     <h2 class="m-0 line-height-16">
                        <span class="titulo-2 fs-18 text-semibold">Tareas Asesores</span><br>
                        <span class="fs-16 f-montserrat-regular">Tareas Asesores</span>
                     </h2>
                  </div>
   ...
   <script type="text/javascript" src="scripts/estudiante_seguimiento_admin_tarea.js"></script>
