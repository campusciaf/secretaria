                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Matriculados</span><br>
                                <span class="fs-16 f-montserrat-regular">Desde aqui se inicia el parche CIAF, viva la experiencia</span>
                            </h2>
                        </div>
            ...
            <section class="content p-4">
                <div class="row">
                    ...
                    <div class="row" id="listadoregistrostres">
                        ...
                        <div class="col-lg-6 py-3 tono-3"><a onClick="volverDos()" class="btn btn-danger float-right text-white"><i class="fas fa-arrow-circle-left"></i> Volver </a></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="crearCredencial" id="crearCredencial" method="POST">
                            ...
                            <input type="text" id="nombre_credencial" value="" name="nombre_credencial" class="form-control">
                            <input type="text" id="nombre2_credencial" value="" name="nombre2_credencial" class="form-control">
                            <input type="text" id="apellido_credencial" value="" name="apellido_credencial" class="form-control">
                            <input type="text" id="apellido2_credencial" value="" name="apellido2_credencial" class="form-control">
                            <input type="text" id="email_credencial" value="" name="email_credencial" class="form-control">
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/oncentermatriculado.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
