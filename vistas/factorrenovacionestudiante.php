...
if (!isset($_SESSION["usuario_nombre"])){
  header("Location: ../");
    ...
    $submenu = 294;
    require 'header.php';
	if ($_SESSION['factorrenovacionestudiante']==1){
?>
          ...
          <div class="row mb-2">
              <div class="col-xl-6 col-9">
                <h2 class="m-0 line-height-16">
                      <span class="titulo-2 fs-18 text-semibold">Renovación Financiera</span><br>
              ...
              <div class="col-12 migas">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Renovación financiera</li>
                    </ol>
              </div>
          </div>
        </div>
...
<script type="text/javascript" src="scripts/factorrenovacionestudiante.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
	ob_end_flush();
?>
