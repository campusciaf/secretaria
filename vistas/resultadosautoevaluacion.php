        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Resultados Autoevaluación</h1>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-end">
                                        ...
                                        <div class="custom-control custom-switch pt-2 ">
                                            <input type="checkbox" class="custom-control-input" id="switch_autoevaluacion">
                                            <label class="custom-control-label estado_autoevaluacion" for="switch_autoevaluacion" style="cursor: pointer;"> -- </label>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="row">
                            <div class="col-12">
                                <table class='table table-hover compact table-sm' id='preguntas_respuestas' style="width: 99%;">
                                    <thead>
                                        <tr>
                                            <th> #</th>
                                            <th> Pregunta </th>
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/resultadosautoevaluacion.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
