...
function init(){
	...
	$.post("../controlador/propuestapoa.php?op=selectListaSiNo", function(r){
	...
	$.post("../controlador/propuestapoa.php?op=selectListarCargo", function(r){
	            $("#compromiso_valida").html(r);
	            $('#compromiso_valida').selectpicker('refresh');
	});
	
	$.post("../controlador/propuestapoa.php?op=condiciones_institucionales&id=",function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	
	$.post("../controlador/propuestapoa.php?op=condiciones_programa&id=",function(r){
...
//	**********************
	...
	$.post("../controlador/propuestapoa.php?op=selectEjes", function(r){
	            $("#meta_ejes").html(r);
	...
	$.post("../controlador/propuestapoa.php?op=selectPeriodo", function(r){
	            $("#meta_periodo").html(r);
	...
	$.post("../controlador/propuestapoa.php?op=selectListarCorresponsable", function(r){
...
function listar(){
	...
	$.post("../controlador/propuestapoa.php?op=listar",{},function(data, status){
...
function listarMeta(){
	...
	$.post("../controlador/propuestapoa.php?op=mostrarmeta",{},function(data, status){
...
function imprimir(id_usuario){
	...
	$.post("../controlador/propuestapoa.php?op=imprimir",{id_usuario : id_usuario}, function(data, status)
	{
		//console.log(data);
			data = JSON.parse(data);
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../controlador/propuestapoa.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function guardaryeditarmeta(e2)
{
	...
	$.ajax({
		url: "../controlador/propuestapoa.php?op=guardaryeditarmeta",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
	    ...
	    { 
			...
			if(id_meta == ""){
				$.post("../controlador/propuestapoa.php?op=fechaLimite",{id_compromiso:id_compromiso}, function(r){
...
{
	$.post("../controlador/propuestapoa.php?op=mostrar",{id_compromiso : id_compromiso}, function(data, status)
	{
...
function mostrarMeta(id_compromiso,fecha)
{
	...
	$.post("../controlador/propuestapoa.php?op=mostrarmeta",{id_compromiso : id_compromiso}, function(data, status)
	{
...
function mostrarMetaEditar(id_meta)
{
	...
	$.post("../controlador/propuestapoa.php?op=mostrarmetaeditar",{id_meta : id_meta}, function(data, status)
	{
		...
		$.post("../controlador/propuestapoa.php?op=condiciones_institucionales&id="+id_meta,function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	$.post("../controlador/propuestapoa.php?op=condiciones_programa&id="+id_meta,function(r){
	        $("#condiciones_programa").html(r);
...
function eliminar(id_compromiso)
{
	alertify.confirm("Eliminar Compromiso","¿Está Seguro de eliminar el compromiso?", function(){
        	...
        	$.post("../controlador/propuestapoa.php?op=eliminar", {id_compromiso : id_compromiso}, function(e){
...
function eliminarMeta(id_meta,linea)
{
	...
	alertify.confirm("Eliminar Meta","¿Está Seguro de eliminar la meta?", function(){
        	...
        	$.post("../controlador/propuestapoa.php?op=eliminarmeta", {id_meta : id_meta}, function(e){
				if(e=='true'){
					alertify.success("Eliminado correctamente");
...
function validarCompromiso(id_compromiso)
{
	...
	alertify.confirm("validar compromiso","¿Está Seguro de validar el compromiso?", function(){
        	...
        	$.post("../controlador/propuestapoa.php?op=validarcompromiso", {id_compromiso : id_compromiso}, function(e){
