...
$("#precarga").hide();
    ...
    $('#calendar').fullCalendar({
		...
		/*Enlace para cargar los eventos de la base de datos*/
			...
			// 		$.ajax({
			// 			url: '../controlador/calendario_poa.php?op=mostrar',
			// 			type: 'GET',
			// 			dataType: "JSON",
		...
		/*Enlace para cargar los eventos de la base de datos*/
		events:'../controlador/calendario_poa.php?op=mostrar',
...
/*Funcion para cargar datos de compromiso*/
// function cargarAccion(id_accion){
// 	$.ajax({
// 		type:'POST',
// 		url:'../controlador/calendario_poa.php?op=cargarAccion',
...
function cargarUsuario(id_usuario){
	$.ajax({
		type:'POST',
		url:'../controlador/calendario_poa.php?op=cargarUsuario',
