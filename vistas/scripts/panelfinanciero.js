...
function  cargarperiodo(){
  ...
  $.post("../controlador/panelfinanciero.php?op=selectPeriodo", function(r){
    $("#periodo").html(r);
...
function cargarjornadas(){
  $.post("../controlador/panelfinanciero.php?op=selectJornada", function(r){
      $("#jornada").html(r);
...
function cargarprograma(escuela,nivel){
  $.post("../controlador/panelfinanciero.php?op=selectPrograma",{escuela:escuela, nivel:nivel},function(r){
      $("#programa_ac").html(r);
...
function buscar(){
  ...
  let programa = new Array();
    ...
    $.post("../controlador/panelfinanciero.php?op=general",{periodo:periodo, escuela:escuela, nivel:nivel, jornada:jornada, semestre:semestre, programa:programa}, function(r){
