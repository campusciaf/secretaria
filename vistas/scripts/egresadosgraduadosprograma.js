...
$.post("../controlador/egresadosgraduadosprograma.php?op=selectPrograma", function(r){
    $("#programa").html(r);
...
function listar(id_programa){
	...
	var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
		tabla=$('#tbllistado').dataTable(
		{
			...
			"ajax":
					{
						url: '../controlador/egresadosgraduadosprograma.php?op=listar&id_programa='+id_programa,
						type : "get",
						dataType : "json",						
						error: function(e){
						}
