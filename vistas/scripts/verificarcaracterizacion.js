...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/verificarcaracterizacion.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../controlador/verificarcaracterizacion.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function eliminar(id_credencial)
{
	alertify.confirm("¿Está Seguro de eliminar el registro?", function(result){
		if(result)
        {
        	$.post("../controlador/verificarcaracterizacion.php?op=eliminar", {id_credencial : id_credencial}, function(e){
