...
function init() {
	...
	$.post("../controlador/carverseresoriginales.php?op=selectPeriodo", function (r) {
		$("#periodo").html(r);
...
//Función Listar
function tablas() {
	$.post("../controlador/carverseresoriginales.php?op=datostabla", {}, function (data, status) {
...
function listar(valor) {
	$("#precarga").show();
	$.post("../controlador/carverseresoriginales.php?op=listar", {valor:valor }, function (data, status) {
		data = JSON.parse(data);
		$("#tbllistado").html("");
