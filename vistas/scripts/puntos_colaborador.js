...
function cargarCategoriasSuperiores() { 
    $.post("../controlador/puntos_colaborador.php?op=totales_generales", {
...
function cargarCategorias() {
    $.post("../controlador/puntos_colaborador.php?op=listar_categorias", {
        fecha_inicio: formatFecha(fechaInicio),
        fecha_fin: formatFecha(fechaFin)
    }, function (data) {
...
function graficoPuntos(categoria) { 
    ...
    $.post("../controlador/puntos_colaborador.php?op=grafico_puntos", {
        categoria,
        fecha_inicio: formatFecha(fechaInicio),
        fecha_fin: formatFecha(fechaFin)
    }, function (data) {
...
function cargarListadoCategoria(categoria) {
    $.post("../controlador/puntos_colaborador.php?op=listado_personas_categoria", {
        categoria: categoria,
        fecha_inicio: formatFecha(fechaInicio),
        fecha_fin: formatFecha(fechaFin)
    }, function (data) {
...
function puntos_totales() {
    $.post("../controlador/puntos_colaborador.php?op=puntos_totales", {
        fecha_inicio: formatFecha(fechaInicio),
        fecha_fin: formatFecha(fechaFin)
    }, function (e) {
