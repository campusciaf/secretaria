...
function listar(){
	$.post("../controlador/cvpaneldocente.php?op=listar",{},function(data){
        console.log(data)
...
function verificarAutoevaluacion(){
	$.post("../controlador/cvpaneldocente.php?op=verificarAutoevaluacion",{},function(data){
    console.log(data);
	data = JSON.parse(data);
		if(data=="1"){
...
function guardaryeditar(e){
	...
	$.ajax({
		"url": "../controlador/cvpaneldocente.php?op=guardaryeditar",
        "type": "POST",
        "data": formData,
        "contentType": false,
        "processData": false,
