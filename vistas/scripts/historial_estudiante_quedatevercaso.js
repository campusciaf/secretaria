...
function mostrarCategoria() {
    $.post("../controlador/historial_estudiante_quedatevercaso.php?op=mostrarCategoria", function (datos) {
        //console.table(datos);
        var opti = "";
...
function buscar_estudiante() {
    ...
    $.post("../controlador/historial_estudiante_quedatevercaso.php?op=buscar_estudiante", { id_caso: id_caso }, function (datos) {//enlace al controlador para traer los datos del estudiante
        //console.table(datos);
...
function listar_docentes() {
    $.post("../controlador/historial_estudiante_quedatevercaso.php?op=listar_docentes", function (datos) {
        ////console.log(datos);
        var r = JSON.parse(datos);
        var opti = '';
...
function listar_dependencias() {
    ...
    /* $.post("../controlador/historial_estudiante_quedatevercaso.php?op=listar_dependencias", function (datos) {
        ////console.log(datos);
        var r = JSON.parse(datos);
        var opti = '';
...
function verdatos() {
    var id = $("#caso_id").val();
    $.post("../controlador/historial_estudiante_quedatevercaso.php?op=verdatos", { id: id }, function (datos) {
        //console.log(datos);
        var r = JSON.parse(datos);
...
function agregar_seguimiento() {
    ...
    $.ajax({
        type: "POST",
        url: "../controlador/historial_estudiante_quedatevercaso.php?op=agregar_seguimiento",
        data: formData,
        contentType: false,
        processData: false,
...
function agregar_tarea() {
    ...
    $.ajax({
        type: "POST",
        url: "../controlador/historial_estudiante_quedatevercaso.php?op=agregar_tarea",
        data: formData,
        contentType: false,
        processData: false,
        success: function (datos) {
...
function agregar_remision() {
    ...
    $.ajax({
        type: "POST",
        url: "../controlador/historial_estudiante_quedatevercaso.php?op=agregar_remision",
        data: formData,
        contentType: false,
        processData: false,
        success: function (datos) {
...
function cerrar_caso() {
    ...
    $.ajax({
        type: "POST",
        url: "../controlador/historial_estudiante_quedatevercaso.php?op=cerrar_caso",
        data: formData,
        contentType: false,
        processData: false,
        success: function (datos) {
