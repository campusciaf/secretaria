let id_cvadministrativos_global = null;
...
$(document).ready(function(){
    ...
    $("input[name='foto']").change(function (){
        var formData = new FormData($("#funcionarios_informacion_personal_form")[0]);
        $("#info_preloader").html('<div class="preloader-box"></div>');
        $.ajax({
            url: "../controlador/hv_fun_informacion_personal.php?op=guardaryeditarImagen",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(datos){
                ...
                if(data.estatus == 1){
                    $(".user-image").attr("src","../cv_funcionarios/usuarios"+data.imagen);
    ...
    $("#funcionarios_informacion_personal_form").off("submit").on("submit",function(e){
        e.preventDefault();
        guardarEditarInformacionPersonal();
    });
    ...
    $('#modal-documentos_adicionales').on('hidden.bs.modal', function () {
     ...
     $.post("../controlador/hv_fun_educacion_formacion.php?op=selectListarNivelFormacion", function (r) {
...
function guardarEditarInformacionPersonal(){
    ...
    var formData = new FormData($("#funcionarios_informacion_personal_form")[0]);
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function guardarEditarExperienciaLaboral(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=guardaryeditarexperiencialaboral",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarExperiencias(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=mostrarexperiencias",
        type: "POST",
        success: function(datos){
            ...
            while(cont < datos.length){
                if(datos[""+cont].id_cvadministrativos == 0){
...
//     $.ajax({
//         url: "../controlador/hv_fun_informacion_personal.php?op=verExperienciaEspecifica",
//         type: "POST",
...
function eliminarExperiencia(id_experiencia){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar esta experiencia laboral?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_informacion_personal.php?op=eliminarExperiencia",
                type: "POST",
                data: {"id_experiencia": id_experiencia},
                success: function(datos){
                    datos = JSON.parse(datos);
...
function guardarEditarEducacion(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_educacion_formacion.php?op=guardaryeditareducacion",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarEducacion(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_educacion_formacion.php?op=mostrarEducacion",
        type: "POST",
        success: function(datos){

            datos = JSON.parse(datos);
            // tomamos el id_cvadministrativos para mostrar el boton de continuar en caso de que tengan dos registros
            id_cvadministrativos_global = datos[0].id_cvadministrativos;
            ...
            while(cont < datos.length){
                if(datos[""+cont].id_cvadministrativos == 0){
                    ...
                    tabla+=`<tr>
                            ...
                            <td><a href="../`+url+`" class="btn btn-link" target="_blank" data-toggle="tooltip" data-placement="left" title="Abrir Certificado en pesataña nueva"><i class="fas fa-link"></i></a></td>
                        </tr>`;
                }
                cont++;
            }
...
function editarEducacion(id_formacion) {
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=verEducacionFormacion",
        type: "POST",
...
function editarExperiencia(id_experiencia) {
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=verExperienciaLaboral",
        type: "POST",
        data: { id_experiencia: id_experiencia },
        success: function (datos) {
            datos = JSON.parse(datos);
...
function eliminarEducacion(id_formacion){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_educacion_formacion	.php?op=eliminarEducacion",
                type: "POST",
                data: {"id_formacion": id_formacion},
                success: function(datos){
                    datos = JSON.parse(datos);
...
function guardarHabilidades(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_habilidad_aptitud.php?op=guardaryeditarhabilidad",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarHabilidades() {
    ...
    $.ajax({
        url: "../controlador/hv_fun_habilidad_aptitud.php?op=mostrarHabilidades",
        type: "POST",
        success: function(datos) {
            datos = JSON.parse(datos);
            var cont = 0;
...
//     $.ajax({
//         url: "../controlador/hv_fun_habilidad_aptitud.php?op=verHabilidadEspecifica",
//         type: "POST",
...
function eliminarHabilidad(id_habilidad){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_habilidad_aptitud.php?op=eliminarHabilidad",
                type: "POST",
                data: {"id_habilidad": id_habilidad},
                success: function(datos){
                    datos = JSON.parse(datos);
...
function guardarReferenciasPersonales(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_referencias_personales.php?op=guardaryeditarreferencias_personales",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        success: function(datos){	
            var data = JSON.parse(datos);
            // validacion para continuar al siguiente paso si tiene mas de dos registros.
            if(data.estatus == 1){
...
function mostrarReferenciasPersonales() {
    ...
    $.ajax({
        url: "../controlador/hv_fun_referencias_personales.php?op=mostrarReferenciasPersonales",
        type: "POST",
        success: function(datos) {
            datos = JSON.parse(datos);
            var cont = 0;
            ...
            while (cont < datos.length && cont < maxRows) { // Limitar a 2 filas
                if (datos["" + cont].id_cvadministrativos == 0) {
                    ...
                    tabla += `<tr>
                            ...
                            <td>` + datos["" + cont].parentesco_referencia_personal + `</td>
                        </tr>`;
                }
                cont++;
            }
...
//     $.ajax({
//         url: "../controlador/hv_fun_referencias_personales.php?op=verReferenciaPersonalEspecifica",
//         type: "POST",
...
function editarReferenciasPersonales(id_referencias) {
    $.ajax({
        ...
        success: function (datos) {
            ...
            $("#parentesco_referencia_personal").val(d.parentesco_referencia_personal);
            $("#parentesco_referencia_personal").val(d.parentesco).selectpicker('refresh');
            // Mostrar el popover manualmente
...
function eliminarReferenciaPersonal(id_referencias){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_referencias_personales.php?op=eliminarReferenciaPersonal",
                type: "POST",
                data: {"id_referencias": id_referencias},
                success: function(datos){
                    datos = JSON.parse(datos);
...
function guardarReferenciaslaborales(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_referencias_laborales.php?op=guardaryeditarreferencias_laborales",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarReferenciasLaborales() {
    ...
    $.ajax({
        url: "../controlador/hv_fun_referencias_laborales.php?op=mostrarReferenciasLaborales",
        type: "POST",
        success: function(datos) {
            datos = JSON.parse(datos);
            var cont = 0;
...
function editarReferenciasLaborales(id_referenciasl) {
    $.ajax({
        url: "../controlador/hv_fun_referencias_laborales.php?op=verReferencialaboralespecifica",
        type: "POST",
...
function eliminarReferenciaLaborales(id_referenciasl){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_referencias_laborales.php?op=eliminarReferenciaLaborales",
                type: "POST",
                data: {"id_referenciasl": id_referenciasl},
                success: function(datos){
                    datos = JSON.parse(datos);
...
function guardarDocumentosObligatorios(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_documentos_obligatorios.php?op=guardaryeditardocumentos_obligatorios",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarDocumentosAdicionales() {
    ...
    $.ajax({
        url: "../controlador/hv_fun_documentos_adicionales.php?op=mostrarDocumentosAdicionales",
        type: "POST",
        success: function(datos) {
            datos = JSON.parse(datos);
            var cont = 0;
            ...
            // if (cont >= 2) {
            // } else {
            //     $('#btnSiguiente_documentos_adicionales').hide();
            // }
        }
    });
}
function eliminarDocumentoObligatorio(id_cvadministrativos, nombre_documentos) {
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_documentos_obligatorios.php?op=eliminarDocumentoObligatorio",
                type: "POST",
                data: {"id_cvadministrativos": id_cvadministrativos, "nombre_documentos": nombre_documentos},
                success: function(datos) {
                    datos = JSON.parse(datos);
                    alertify.message(datos.valor);
                    mostrarDocumentosObligatorios();
...
function eliminarDocumentoObligatoriootrosestudios(id_documentacion) {
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_documentos_obligatorios.php?op=eliminarDocumentoObligatoriootrosestudios",
                type: "POST",
...
function guardarDocumentosAdicionales(){
    ...
    $.ajax({
    url: "../controlador/hv_fun_documentos_adicionales.php?op=guardaryeditardocumentos_adicionales",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function eliminarDocumentoAdicional(id_documentoA){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_documentos_adicionales.php?op=eliminarDocumentoAdicional",
                type: "POST",
...
function guardarArea(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_areas_de_conocimiento.php?op=guardaryeditararea",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrarAreas(){
    ...
    $.ajax({
        url: "../controlador/hv_fun_areas_de_conocimiento.php?op=mostrarAreas",
        type: "POST",
        success: function(datos){
            datos = JSON.parse(datos);
            var cont = 0;
...
function eliminarArea(id_area){
    alertify.confirm('Confirmar eliminación', 'Realmente desea eliminar este dato?', 
        function(){ 
            $.ajax({
                url: "../controlador/hv_fun_areas_de_conocimiento.php?op=eliminarArea",
                type: "POST",
...
function mostrarDocumentosObligatorios() {
    $.post("../controlador/hv_fun_documentos_obligatorios.php?op=mostrarDocumentosObligatorios", {}, function (data) {
            ...
            //     var columnadocumento = $(this).find('td').eq(2).text();
            //     columnadocumento = $.trim(columnadocumento);
            //     if (columnadocumento === 'Falta Subir') {
            //         boton = false;
            //         return false; 
            //     }
            // });
...
function mostrarArchivo() {
    // $("#precarga").show();
    $.post("../controlador/hv_fun_documentos_obligatorios.php?op=mostrarotrosestudios", {}, function (e) {
            var r = JSON.parse(e);
...
function CrearDocumentoObligatorio(id_cvadministrativos, nombre_documentos) {
    $("#id_cvadministrativos_documento_obligatorio").val(id_cvadministrativos);
...
function avanzarAlSiguientePaso() {
    ...
    for (let i = 1; i <= 9; i++) {
        if ($("#form" + i).is(":visible")) {
            ...
            if (porcentaje) {
                actualizar_porcentaje_continuar(id_cvadministrativos_global, porcentaje, i);
                activarPasosPorPorcentaje(porcentaje);
                // si estamos en el paso 7 documentos obligatorios actualiza el porcentaje de avance cuando le damos en continuar 
                if (i === 7) {
                    activarPasosPorPorcentaje(77);
                    actualizar_porcentaje_paso7();
                }
...
function actualizar_porcentaje_continuar(id_cvadministrativos_global, porcentaje) {
    $.ajax({
        url: "../controlador/hv_fun_educacion_formacion.php?op=actualizar_porcentaje_continuar",
        type: "POST",
        data: {
            "id_cvadministrativos_global": id_cvadministrativos_global,
...
function activarPasosPorPorcentaje(porcentaje) {
    ...
    const pasos = Math.floor(porcentaje / 9);
    for (let i = 1; i <= 9; i++) {
...
function actualizar_porcentaje_paso7(){
    $.ajax({
        url: "../controlador/hv_fun_documentos_obligatorios.php?op=actualizar_porcentaje_avance",
        type: "POST",
        data: {},
        success: function(datos){
            datos = JSON.parse(datos);
...
function toggleSubir(index, valor, id_cvadministrativos,nombre_documentos) {
    ...
    if (valor) {
        ...
        ActualizarEstadoTarjetaProfesionalRut(valor, id_cvadministrativos, nombre_documentos);
    }
...
function ActualizarEstadoTarjetaProfesionalRut(valor, id_cvadministrativos, nombre_documentos) {
    const valorNumerico = valor ? 1 : 0;
    $.ajax({
        url: "../controlador/hv_fun_documentos_obligatorios.php?op=ActualizarEstadoRutTarjetaProfesional",
        type: "POST",
        data: {
            "valor": valorNumerico,
...
function ajustarBotones(porcentaje) {
    ...
    const pasos_a_activar = Math.floor(porcentaje / 9); // devuelve el numero de botones a activar segun el porcentaje.
...
function CrearDocumentosAdicionalesPopover(event) {
    ...
    const boton = event.currentTarget;
    const popover = document.querySelector("#popoverDocumentosAdicionales");
    const contenedor = document.querySelector("#form8");
    const contenedorRect = contenedor.getBoundingClientRect();
    const buttonRect = boton.getBoundingClientRect();
    const offsetTop = buttonRect.top - contenedorRect.top + boton.offsetHeight + 5;
    const offsetLeft = buttonRect.left - contenedorRect.left;
...
function validarExperienciaLaboralInicial() {
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=validarExperienciaLaboralInicial",
        type: "POST",
        data: { id_cvadministrativos: id_cvadministrativos }, // pásalo según tu lógica
        success: function (respuesta) {
            let data = JSON.parse(respuesta);
            if (data.total_registros >= 2) {
                avanzarAlSiguientePaso(); // o desbloquea el paso 4
                activarPasosPorPorcentaje(data.porcentaje);
                ajustarBotones(data.porcentaje);
            }
        }
...
function ActualizarEstadoPoliticamenteExpuesto(valor, id_cvadministrativos) {
    // const valorNumerico = valor ? 1 : 0;
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=ActualizarEstadoPoliticamenteExpuesto",
        type: "POST",
        data: {
            "valor": valor,
            "id_cvadministrativos": id_cvadministrativos,
...
// actualizamos el estado de la experiencia docente.
function ActualizarEstadoExperienciaDocente(valor, id_cvadministrativos) {
    // const valorNumerico = valor ? 1 : 0;
    $.ajax({
        url: "../controlador/hv_fun_informacion_personal.php?op=ActualizarEstadoExperienciaDocente",
        type: "POST",
        data: {
            "valor": valor,
            "id_cvadministrativos": id_cvadministrativos,
