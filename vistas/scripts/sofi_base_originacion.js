...
function init(){
	listarBaseOriginacion();
}

function listarBaseOriginacion(){
    $("#precarga").show();
    tabla_base_originacion = $('#tabla_base_originacion').dataTable({
		"aProcessing": true,
		"aServerSide": true,
		"autoWidth": false,
		"dom": 'Bfrtip',
		...
		"ajax":{
			"url": "../controlador/sofi_base_originacion.php?op=listarBaseOriginacion",
			"type" : "POST",
			"dataType" : "json",
			"error": function(e){
