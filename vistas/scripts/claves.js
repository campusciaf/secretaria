...
function listarClaves(periodo){
        ...
        tabla=$('#tbllistado').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controlador/claves.php?op=listarClaves',
                        type : "POST",
...
function agregarClave(e) {
    ...
    $.ajax({
        type: "POST",
        url: "../controlador/claves.php?op=agregar",
        data: formData,
        contentType: false,
        processData: false,
...
function eliminarSalon(id) {
    alertify.confirm('Eliminar salón', 'Desea eliminar el salón '+id, function () {
        ...
        $.post("../controlador/claves.php?op=eliminar", { id: id }, function (data, status) {
...
function estado(id,est) {
    ...
    alertify.confirm('Cambio de estado', function () {
        $.post("../controlador/claves.php?op=estado", { id: id, est:est }, function (data) {
            console.log(data);
            var r = JSON.parse(data);
            if (r.conte == "1") {
...
function mostrarplataforma(id_clave){
	$.post("../controlador/claves.php?op=mostrarplataforma",{"id_clave" : id_clave},function(data){
		// console.log(data);
...
function guardaryeditarplataforma(e1){
	...
	$.ajax({
		"url": "../controlador/claves.php?op=guardaryeditarplataforma",
		"type": "POST",
		"data": formData,
		"contentType": false,
		"processData": false,
