function init(){
	...
	$.post("../controlador/sofiasesores.php?op=selectAsesor", function(r){
	            $("#asesor").html(r);
...
function buscarfiltrar(e)
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/sofiasesores.php?op=listar&asesor='+asesor+'&fecha_desde='+fecha_desde+'&fecha_hasta='+fecha_hasta,
					type : "get",
					dataType : "json",						
					error: function(e){
...
function datos(){
	$.post('../controlador/sofiasesores.php?op=datos', function(datos){
...
function datosEtiquetas(){
	$.post('../controlador/sofiasesores.php?op=datosEtiquetas', function(datos){
		var r = JSON.parse(datos);
