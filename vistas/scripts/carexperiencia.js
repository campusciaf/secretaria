function init() {
    ...
    function editarDatosPersona(e) {
        ...
        var formData = new FormData($("#formulariodatos")[0]);
                ...
                $.ajax({
                    type: "POST",
                    url: "../controlador/carexperiencia.php?op=guardaryeditar",
                    data: formData,
                    contentType: false,
                    processData: false,
    ...
    function verificar(){ ;
        $.post("../controlador/carexperiencia.php?op=verificar", function(data){
    ...
    function guardardata(e2)
    {
        ...
        $.ajax({
            url: "../controlador/carexperiencia.php?op=guardardata",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    function listarPreguntas(){
        $("#precarga").show(); 
        $.post("../controlador/carexperiencia.php?op=listarPreguntas", function(data){	
            r = JSON.parse(data);
    ...
    function mostrarp7(){
        var campop7=$("#p7").find("option:selected").html();
        if(campop7=="No"){
