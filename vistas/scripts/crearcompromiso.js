...
function init(){
	...
	$.post("../controlador/crearcompromiso.php?op=selectPeriodo", function(r){
	            ...
	            $("#compromiso_periodo").html(r);
	           	$('#compromiso_periodo').selectpicker('refresh');
	
	});
	
	$.post("../controlador/crearcompromiso.php?op=selectListaSiNo", function(r){
	...
	$.post("../controlador/crearcompromiso.php?op=selectListarCargo", function(r){
...
//	**********************
	...
	$.post("../controlador/crearcompromiso.php?op=selectEjes", function(r){
	            $("#meta_ejes").html(r);
...
//	});
	...
	$.post("../controlador/crearcompromiso.php?op=condiciones_institucionales&id=",function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	
	$.post("../controlador/crearcompromiso.php?op=condiciones_programa&id=",function(r){
...
function limpiar()
{
	...
	$("#compromiso_periodo").val("");
	$("#compromiso_periodo").change();
	$('#compromiso_periodo').selectpicker('refresh');
...
function listar3(){
	...
	$.post("../controlador/crearcompromiso.php?op=listar",{},function(data, status){
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/crearcompromiso.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla2=$('#tbllistado2').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/crearcompromiso.php?op=listar2',
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
function listarMeta(){
	...
	$.post("../controlador/crearcompromiso.php?op=mostrarmeta",{},function(data, status){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../controlador/crearcompromiso.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function guardaryeditarmeta(e2)
{
	...
	$.ajax({
		url: "../controlador/crearcompromiso.php?op=guardaryeditarmeta",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
	    ...
	    { 
			...
			if(id_meta == ""){
				$.post("../controlador/crearcompromiso.php?op=fechaLimite",{id_compromiso:id_compromiso}, function(r){
...
{
	$.post("../controlador/crearcompromiso.php?op=mostrar",{id_compromiso : id_compromiso}, function(data, status)
	{
...
function mostrarMeta(id_compromiso,fecha,periodo)
{
	...
	$.post("../controlador/crearcompromiso.php?op=mostrarmeta",{id_compromiso : id_compromiso}, function(data, status)
	{
			//console.log(data);
			data = JSON.parse(data);
...
function mostrarMeta2(id_compromiso,fecha,periodo)
{
	...
	$.post("../controlador/crearcompromiso.php?op=mostrarmeta2",{id_compromiso : id_compromiso}, function(data, status)
	{
			//console.log(data);
			data = JSON.parse(data);
...
function mostrarMetaEditar(id_meta)
{
	...
	$.post("../controlador/crearcompromiso.php?op=mostrarmetaeditar",{id_meta : id_meta}, function(data, status)
	{
	...
	$.post("../controlador/crearcompromiso.php?op=condiciones_institucionales&id="+id_meta,function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	
	$.post("../controlador/crearcompromiso.php?op=condiciones_programa&id="+id_meta,function(r){
	        $("#condiciones_programa").html(r);
...
function eliminar(id_compromiso)
{
	alertify.confirm("Eliminar Compromiso","¿Está Seguro de eliminar el compromiso?", function(){
        	...
        	$.post("../controlador/crearcompromiso.php?op=eliminar", {id_compromiso : id_compromiso}, function(e){
				//console.log(e);
				if(e=='true'){
...
function eliminarMeta(id_meta,linea)
{
	...
	alertify.confirm("Eliminar Meta","¿Está Seguro de eliminar la meta?", function(){
        	...
        	$.post("../controlador/crearcompromiso.php?op=eliminarmeta", {id_meta : id_meta}, function(e){
