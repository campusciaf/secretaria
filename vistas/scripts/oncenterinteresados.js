...
function iniciarTour(){
	introJs().setOptions({
		...
		steps: [ 
			{
				title: 'Interesados',
				intro: "Bienvenido a nuestro módulo de personas interesadas,donde tendrás la oportunidad de conocer a las personas interesadas en formar parte de nuestra institución y tendrás acceso a distintos paneles de información"
			},
...

			{
				...
				intro: "Aquí podrás encontrar el estado de cada ser creativo en este caso interesado y elnombre cambia en cada panel "
			},
			{
				title: 'Campaña actual',
				element: document.querySelector('#t-Ca'),
				intro: "Aquí encontrarás a todas las personas interesadas en nuestra campaña actual "
			},
			{
				title: 'Campaña anteriores',
				element: document.querySelector('#t-Cn'),
				intro: "Aquí encontrarás a todas las personas interesadas en nuestra campañas anteriores "
			},
			{
				title: 'Sede principal',
				element: document.querySelector('#t-paso0'),
				intro: "Aquí podrás encontrar el programa de interés en nuestra sede prncipal "
			},
			{
				title: 'Marketing-digital',
				element: document.querySelector('#t-paso1'),
				intro: "Aquí podrás encontrar el programa de interés en marketin-digital"
			},
			{
				title: 'Web',
				element: document.querySelector('#t-paso2'),
				intro: " Aquí podrás encontrar el programa de interés por nuestra web"
			},
			{
				title: 'Súmate al parche',
				element: document.querySelector('#t-paso3'),
				intro: "Aquí podrás encontrar el programa de interés en súmate al parche"
			},
			{
				title: 'volante',
				element: document.querySelector('#t-paso4'),
				intro: "Aquí podrás encontrar el programa de interés por que la persona interesada nos conoció por medio de un volante "
			},
			{
				title: 'Feria',
				element: document.querySelector('#t-paso5'),
				intro: "Aquí podrás encontrar el programa de interés por que la persona interesada nos conoció por medio de nuestra feria "
			},
...
function iniciarSegundoTour() {
	introJs().setOptions({
		...
		"steps": [{
			"title": 'Interesados',
			"intro": 'Bienvenido a nuestro módulo de personas interesadas'
		},
		{
			"title": 'Programa',
			"element": document.querySelector('#t2-paso0'),
			"intro": "Aquí encontrarás los diferentes programas de interés para las personas "
		},
		{
			"title": 'Ninguno',
		...
		},
		{
			...
			"intro": "Regresa el tiempo en nuestro campus y encontrarás nuevamente nuestro panel de interesados"
		},
...
function listar(){
	$("#precarga").show();
	$.post("../controlador/oncenterinteresados.php?op=listar",{},function(data, status){
		...
		$.post("../controlador/oncenterinteresados.php?op=selectPeriodo",{},function(data, status){
...
function listarDos(periodo,nombre_criterio){
	...
	$("#precarga").show();
	$.post("../controlador/oncenterinteresados.php?op=listarDos",{periodo:periodo, nombre_criterio:nombre_criterio},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
...
function listarTres(nombre_criterio,medio,periodo){
	...
	$.post("../controlador/oncenterinteresados.php?op=listarTres",{nombre_criterio:nombre_criterio, medio:medio, periodo:periodo},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
...
function verEstudiantes(nombre_programa,jornada,estado,periodo){
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantes&nombre_programa='+nombre_programa+'&jornada='+jornada+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
...
function verEstudiantesmedio(nombre_programa,jornada,medio,estado,periodo)
{
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantesMedio&nombre_programa='+nombre_programa+'&jornada='+jornada+'&medio='+medio+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
function verEstudiantesSuma(jornada,estado,periodo)
{
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantesSuma&jornada='+jornada+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
// funcion para listar los estudaintes por suma de programa y jornada
function verEstudiantesSumaMedio(jornada,medio,nombre_criterio,periodo)
{
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantesSumaMedio&jornada='+jornada+'&medio='+medio+'&nombre_criterio='+nombre_criterio+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
// funcion para listar los estudaintes por suma de programa y jornada
function verEstudiantesTotal(periodo,nombre_criterio)
{
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantesTotal&nombre_criterio='+nombre_criterio+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
function verEstudiantesTotalMedio(medio,periodo,nombre_criterio)
{
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verEstudiantesTotalMedio&medio='+medio+'&nombre_criterio='+nombre_criterio+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
function verHistorial(id_estudiante){
	$("#precarga").show();
	$.post("../controlador/oncenterinteresados.php?op=verHistorial",{id_estudiante:id_estudiante},function(data, status){
...
function verHistorialTabla(id_estudiante)
{
	...
	tabla=$('#tbllistadohistorial').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verHistorialTabla&id_estudiante='+id_estudiante,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
function verHistorialTablaTareas(id_estudiante)
{
	...
	tabla=$('#tbllistadoHistorialTareas').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/oncenterinteresados.php?op=verHistorialTablaTareas&id_estudiante='+id_estudiante,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectModalidadCampana", function(r){
			$("#modalidad_campana").html(r);
			$('#modalidad_campana').selectpicker('refresh');
	});
}

function validarDocumento(id_estudiante,identificacion,fila){
	//$("#precarga").show();
...
{	
	...
	if(nuevo_documento==repetir_documento){
		...
		$.ajax({
			url: "../controlador/oncenterinteresados.php?op=verificarDocumento&nuevodocumento="+nuevo_documento,
			type: "POST",
			data: formData,
			contentType: false,
			processData: false,
...
function selectEstado(){
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectEstado", function(r){
	            $("#estado").html(r);
...
function guardarMoverUsuario(e4)
{
	...
	$.ajax({
		url: "../controlador/oncenterinteresados.php?op=moverUsuario",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
/*function eliminar(id_estudiante,fila)
{
	alertify.confirm('Eliminar Caso', '¿Está Seguro de eliminar el Caso?', function(){ 
		...
		$.post("../controlador/oncenterinteresados.php?op=eliminar", {id_estudiante : id_estudiante}, function(e){
				console.log(e);
        		if(e == 1){
...
//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectPrograma", function(r){
			$("#fo_programa").html(r);
...
//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectJornada", function(r){
			$("#jornada_e").html(r);
...
//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectTipoDocumento", function(r){
...
//Cargamos los items de los selects
	$.post("../controlador/oncenterinteresados.php?op=selectNivelEscolaridad", function(r){
...
function perfilEstudiante(id_estudiante,identificacion,fila){
	...
	$.post("../controlador/oncenterinteresados.php?op=perfilEstudiante", {id_estudiante : id_estudiante},function(data, status)
	{		
...
function editarPerfil(e5){
	...
	$.ajax({
		url: "../controlador/oncenterinteresados.php?op=editarPerfil",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function cambiarEtiqueta(id_estudiante,valor) {
	$.post("../controlador/oncenterinteresados.php?op=cambiarEtiqueta",{id_estudiante:id_estudiante, valor:valor},function(data){
		if (data == 1) {
