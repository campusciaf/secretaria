...
function init(){
	...
	$.post("../controlador/estadoegresado.php?op=selectPrograma", function(r){
		$("#programa_ac").html(r);
		$('#programa_ac').selectpicker('refresh');
	});
	
	$.post("../controlador/estadoegresado.php?op=selectPeriodo", function(r){
		$("#periodo").html(r);
		$('#periodo').selectpicker('refresh');
	});
}
//Función Listar
function listar(programa,periodo)
{
	$("#precarga").show();
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/estadoegresado.php?op=listar&programa='+programa+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
...
function consultar(e)
{
	...
	$.ajax({
		url: "../controlador/estadoegresado.php?op=consultar",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
		...
		var r = JSON.parse(datos);
			...
			var periodo=r.periodo;
			listar(programa,periodo);
		}
	});
...
// 		$.post("../controlador/estadoegresado.php?op=desactivar", {id_programa : id_programa}, function(e){
...
// 	$.post("../controlador/estadoegresado.php?op=activar", {id_programa : id_programa}, function(e){
