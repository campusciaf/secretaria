...
$.post("../controlador/consultagraduados.php?op=selectPeriodo", function(r){
    $("#periodo").html(r);
...
function listarNuevos(periodo,estado){
	...
	$("#precarga").show();
	$.post("../controlador/consultagraduados.php?op=listarDos",{periodo:periodo, estado:estado},function(data, status){	
...
function listar(){
	$("#precarga").show();
	$.post("../controlador/consultagraduados.php?op=listar",{},function(data, status){
		data = JSON.parse(data);// convertir el mensaje a json
		$("#resultado").show();
		$("#resultadoDos").hide();
		...
		$("#precarga").hide();
		$.post("../controlador/consultagraduados.php?op=selectPeriodo",{},function(data, status){
			data = JSON.parse(data);// convertir el mensaje a json
			var ancho=data["0"]["1"];
			var a=0;
			while(a < ancho){
...
function listarTres(nombre_estado,medio,periodo){
	...
	var fecha=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	$("#precarga").show();
	$.post("../controlador/consultagraduados.php?op=listarTres",{nombre_estado:nombre_estado, medio:medio, periodo:periodo},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
		$(document).ready(function() {
			$('#tbllistado').DataTable({
				"paging":   false,
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultagraduados.php?op=verEstudiantes&fo_programa='+fo_programa+'&jornada='+jornada+'&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultagraduados.php?op=verEstudiantesMedio&nombre_programa='+nombre_programa+'&jornada='+jornada+'&medio='+medio+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultagraduados.php?op=verEstudiantesSuma&jornada='+jornada+'&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultagraduados.php?op=verEstudiantesTotal&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultagraduados.php?op=verEstudiantesTotalMedio&medio='+medio+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
					}
