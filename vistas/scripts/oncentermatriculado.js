...
function iniciarTour() {
	introJs().setOptions({
		...
		steps: [
			{
				title: 'Matriculados',
				intro: "Bienvenido a nuestro módulo de seres creativos matriculados "
			},
			{
			...
			},
			{
				...
				intro: "Aquí encontrarás a todos nuestros seres creativos que se matricularon en nuestra campaña actual "
			},
			{
				title: 'Campaña anteriores',
				element: document.querySelector('#t-Cn'),
				intro: "Aquí encontrarás a todos nuestros seres creativos que se matricularon en nuestras campañas anteriores "
			},
			{
				title: 'Sede principal',
				element: document.querySelector('#t-paso0'),
				intro: "Aquí podrás encontrar el programa que fue matriculado en nuestra sede prncipal "
			},
			{
				title: 'Marketing-digital',
				element: document.querySelector('#t-paso1'),
				intro: "Aquí podrás encontrar el programa que fue matriculado en marketin-digital"
			},
			{
				title: 'Web',
				element: document.querySelector('#t-paso2'),
				intro: " Aquí podrás encontrar el programa que fue matriculado por nuestra web"
			},
			{
				title: 'Súmate al parche',
				element: document.querySelector('#t-paso3'),
				intro: "Aquí podrás encontrar el programa que fue matriculado en súmate al parche"
			},
			{
				title: 'volante',
				element: document.querySelector('#t-paso4'),
				intro: "Aquí podrás encontrar el programa que fue matriculado por que nuestro ser creativo nos conoció por un volante "
			},
			{
				title: 'Feria',
				element: document.querySelector('#t-paso5'),
				intro: "Aquí podrás encontrar el programa que fue matriculado por que nuestro ser creativo nos conoció por medio de nuestra feria "
			},
			{
				title: 'Caso',
...
function iniciarSegundoTour() {
	introJs().setOptions({
		...
		},
		{
			...
			"intro": "Aquí encontrarás los diferentes programas a los que nuestros seres creativos han pensado en matricularse "
		},
		{
			"title": 'Ninguno',
...
function listar() {
	$("#precarga").show();
	$.post("../controlador/oncentermatriculado.php?op=listar", {}, function (data, status) {
		...
		$("#precarga").hide();
		$.post("../controlador/oncentermatriculado.php?op=selectPeriodo", {}, function (data, status) {
			data = JSON.parse(data);// convertir el mensaje a json
...
function listarDos(periodo) {
	...
	$("#precarga").show();
	$.post("../controlador/oncentermatriculado.php?op=listarDos", { periodo: periodo }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
...
function listarTres(medio, periodo) {
	...
	$.post("../controlador/oncentermatriculado.php?op=listarTres", { medio: medio, periodo: periodo }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
		$(document).ready(function () {
			$('#tbllistado').DataTable({
				"paging": false,
	...
	tabla = $('#tbllistadoestudiantes').dataTable(
		{
			...
			buttons: [
				...
				},
				{
					extend: 'print',
					text: '<i class="fas fa-print fa-2x" style="color: #ff9900"></i>',
					messageTop: '<div style="width:50%;float:left">Programa: <b>' + nombre_programa + '</b><br>Reporte: <b>' + usuario_cargo + ' </b><br>Fecha Reporte: <b> ' + fecha_hoy + '</b> </div><div style="width:50%;float:left;text-align:right;margin-top:-30px; position:relative"><img src="../public/img/logo_ciaf_web.png" width="200px"><br><br></div>',
					title: 'Matriculado',
					titleAttr: 'Print'
				},
			],
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantes&nombre_programa=' + nombre_programa + '&jornada=' + jornada + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
...
// funcion para listar los estudaintes por programa y jornada
function verEstudiantesmedio(nombre_programa, jornada, medio, periodo, usuario_cargo) {
	var estado = "Matriculado";
	var meses = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
	var diasSemana = new Array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado");
	var f = new Date();
	...
	tabla = $('#tbllistadoestudiantes').dataTable(
		{
			...
			buttons: [
				...
				},
				{
					//extend: 'print',
					//text: '<i class="fas fa-print fa-2x" style="color: #ff9900"></i>',
					//messageTop: '<div style="width:50%;float:left">Programa: <b>' + nombre_programa + '</b><br>Asesor: <b>' + usuario_cargo + '</b><br>Reporte: <b>' + estado + ' </b><br>Fecha Reporte: <b> ' + fecha_hoy + '</b> </div><div style="width:50%;float:left;text-align:right;margin-top:-30px; position:relative"><img src="../public/img/logo_ciaf_web.png" width="200px"><br><br></div>',
					//title: 'Matriculado',
					//titleAttr: 'Print'
				},
			],
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantesMedio&nombre_programa=' + nombre_programa + '&jornada=' + jornada + '&medio=' + medio + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantessuma').dataTable(
		{
			...
			buttons: [
				...
				},
				{
					//extend: 'print',
					//text: '<i class="fas fa-print fa-2x" style="color: #ff9900"></i>',
					//messageTop: '<div style="width:50%;float:left">Asesor: <b>' + usuario_cargo + '</b><br>Reporte: <b>' + estado + ' </b><br>Fecha Reporte: <b> ' + fecha_hoy + '</b> </div><div style="width:50%;float:left;text-align:right;margin-top:-30px; position:relative"><img src="../public/img/logo_ciaf_web.png" width="200px"><br><br></div>',
					//title: 'Ejes',
					//titleAttr: 'Print'
				},
			],
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantesSuma&jornada=' + jornada + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
...
// funcion para listar los estudaintes por suma de programa y jornada
function verEstudiantesSumaMedio(nombre_programa, jornada, medio, periodo, usuario_cargo) {
	var estado = "Matriculado";
	var meses = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
	var diasSemana = new Array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado");
	var f = new Date();
	...
	tabla = $('#tbllistadoestudiantessuma').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantesSumaMedio&jornada=' + jornada + '&medio=' + medio + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantestotal').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantesTotal&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantesmedio').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verEstudiantesTotalMedio&medio=' + medio + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
...
function verHistorial(id_estudiante) {
	$("#precarga").show();
	$.post("../controlador/oncentermatriculado.php?op=verHistorial", { id_estudiante: id_estudiante }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
...
function agregar(id_estudiante) {
	...
	$.post("../controlador/oncentermatriculado.php?op=agregar", { id_estudiante: id_estudiante }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
	...
	tabla = $('#tbllistadohistorial').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verHistorialTabla&id_estudiante=' + id_estudiante,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
	...
	tabla = $('#tbllistadoHistorialTareas').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncentermatriculado.php?op=verHistorialTablaTareas&id_estudiante=' + id_estudiante,
				type: "get",
				dataType: "json",
				error: function (e) {
					// console.log(e.responseText);
...
function selectModalidadCampana() {
	...
	$.post("../controlador/oncentermatriculado.php?op=selectModalidadCampana", function (r) {
...
function guardarCambioDocumento(e3) {
	...
	if (nuevo_documento == repetir_documento) {
		$.ajax({
			url: "../controlador/oncentermatriculado.php?op=verificarDocumento&nuevodocumento=" + nuevo_documento,
			type: "POST",
			data: formData,
			contentType: false,
			processData: false,
...
function selectEstado() {
	//Cargamos los items de los selects
	$.post("../controlador/oncentermatriculado.php?op=selectEstado", function (r) {
		$("#estado").html(r);
...
function guardarMoverUsuario(e4) {
	...
	$.ajax({
		url: "../controlador/oncentermatriculado.php?op=moverUsuario",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
/*function eliminar(id_estudiante, fila) {
	alertify.confirm('Eliminar Caso', '¿Está Seguro de eliminar el Caso?', function () {
		$.post("../controlador/oncentermatriculado.php?op=eliminar", { id_estudiante: id_estudiante }, function (e) {
			if (e == 1) {
...
function selectPrograma() {
	//Cargamos los items de los selects
	$.post("../controlador/oncentermatriculado.php?op=selectPrograma", function (r) {
		$("#fo_programa").html(r);
...
function selectJornada() {
	//Cargamos los items de los selects
	$.post("../controlador/oncentermatriculado.php?op=selectJornada", function (r) {
		$("#jornada_e").html(r);
...
function selectTipoDocumento() {
	//Cargamos los items de los selects
	$.post("../controlador/oncentermatriculado.php?op=selectTipoDocumento", function (r) {
...
function selectNivelEscolaridad() {
	//Cargamos los items de los selects
	$.post("../controlador/oncentermatriculado.php?op=selectNivelEscolaridad", function (r) {
...
function perfilEstudiante(id_estudiante, identificacion, fila) {
	...
	$("#fila").val(fila);
	$.post("../controlador/oncentermatriculado.php?op=perfilEstudiante", { id_estudiante: id_estudiante }, function (data, status) {
...
function editarPerfil(e5) {
	...
	$.ajax({
		url: "../controlador/oncentermatriculado.php?op=editarPerfil",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
function correo(id_estudiante) {
	alertify.confirm('Enviar Mensaje', '¿Está Seguro de enviar las credenciales al usuario?', function () {
		$.post("../controlador/oncentermatriculado.php?op=correo", { id_estudiante: id_estudiante }, function (e) {
