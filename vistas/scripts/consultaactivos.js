	...
	tabla=$('#tbllistadoconfig').dataTable(
		{
			...
			"ajax":
					{
						url: '../controlador/consultaactivos.php?op=configurar',
						type : "get",
						dataType : "json",						
						error: function(e){
...
function cambioestado(id_programa,estado){
	...
	$.post("../controlador/consultaactivos.php?op=cambioestado",{id_programa:id_programa,estado:estado},function(data, status){
...
function listarActivos(){
	...
	$("#precarga").show();
	$.post("../controlador/consultaactivos.php?op=listarActivos",{},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
...
function listar(){
	$("#precarga").show();
	$.post("../controlador/consultaactivos.php?op=listar",{},function(data, status){
		data = JSON.parse(data);// convertir el mensaje a json
		$("#resultado").show();
		$("#resultadoDos").hide();
		...
		$.post("../controlador/consultaactivos.php?op=selectPeriodo",{},function(data, status){
    		data = JSON.parse(data);// convertir el mensaje a json
            var ancho=data["0"]["1"];
    		var a=0;
    		while(a < ancho){
...
function listarDos(periodo,estado){
	...
	$("#precarga").show();
	$.post("../controlador/consultaactivos.php?op=listarDos",{periodo:periodo, estado:estado},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
...
function listarTres(nombre_estado,medio,periodo){
	...
	$("#precarga").show();
	$.post("../controlador/consultaactivos.php?op=listarTres",{nombre_estado:nombre_estado, medio:medio, periodo:periodo},function(data, status){	
		data = JSON.parse(data);// convertir el mensaje a json
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultaactivos.php?op=verEstudiantes&fo_programa='+fo_programa+'&jornada='+jornada+'&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultaactivos.php?op=verEstudiantesMedio&nombre_programa='+nombre_programa+'&jornada='+jornada+'&medio='+medio+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultaactivos.php?op=verEstudiantesSuma&jornada='+jornada+'&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultaactivos.php?op=verEstudiantesTotal&periodo='+periodo+'&estado='+estado,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
...
var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
	...
	tabla=$('#tbllistadoestudiantes').dataTable(
	{
		...
		"ajax":
				{
					url: '../controlador/consultaactivos.php?op=verEstudiantesTotalMedio&medio='+medio+'&estado='+estado+'&periodo='+periodo,
					type : "get",
					dataType : "json",						
					error: function(e){
						console.log(e.responseText);	
