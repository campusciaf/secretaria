...
function init(){
	...
	$.post("../controlador/compromiso.php?op=selectListaSiNo", function(r){
	...
	$.post("../controlador/compromiso.php?op=selectListarCargo", function(r){
...
//	**********************
	...
	$.post("../controlador/compromiso.php?op=selectEjes", function(r){
	            $("#meta_ejes").html(r);
	...
	$.post("../controlador/compromiso.php?op=selectPeriodo", function(r){
	            $("#meta_periodo").html(r);
	...
	$.post("../controlador/compromiso.php?op=condiciones_institucionales&id=",function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	
	$.post("../controlador/compromiso.php?op=condiciones_programa&id=",function(r){
...
function listar(){
	...
	$.post("../controlador/compromiso.php?op=listar",{},function(data, status){
...
function listarMeta(){
	...
	$.post("../controlador/compromiso.php?op=mostrarmeta",{},function(data, status){
...
function imprimir(id_usuario){
	...
	$.post("../controlador/compromiso.php?op=imprimir",{id_usuario : id_usuario}, function(data, status)
	{
		//console.log(data);
			data = JSON.parse(data);
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../controlador/compromiso.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function guardaryeditarmeta(e2)
{
	...
	$.ajax({
		url: "../controlador/compromiso.php?op=guardaryeditarmeta",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
	    ...
	    { 
			...
			if(id_meta == ""){
				$.post("../controlador/compromiso.php?op=fechaLimite",{id_compromiso:id_compromiso}, function(r){
...
{
	$.post("../controlador/compromiso.php?op=mostrar",{id_compromiso : id_compromiso}, function(data, status)
	{
...
function mostrarMeta(id_compromiso,fecha)
{
	...
	$.post("../controlador/compromiso.php?op=mostrarmeta",{id_compromiso : id_compromiso}, function(data, status)
	{
...
function mostrarMetaEditar(id_meta)
{
	...
	$.post("../controlador/compromiso.php?op=mostrarmetaeditar",{id_meta : id_meta}, function(data, status)
	{
	...
	$.post("../controlador/compromiso.php?op=condiciones_institucionales&id="+id_meta,function(r){
	        $("#condiciones_institucionales").html(r);
		
	});
	$.post("../controlador/compromiso.php?op=condiciones_programa&id="+id_meta,function(r){
	        $("#condiciones_programa").html(r);
...
function eliminar(id_compromiso)
{
	alertify.confirm("Eliminar Compromiso","¿Está Seguro de eliminar el compromiso?", function(){
        	...
        	$.post("../controlador/compromiso.php?op=eliminar", {id_compromiso : id_compromiso}, function(e){
...
function eliminarMeta(id_meta,linea)
{
	...
	alertify.confirm("Eliminar Meta","¿Está Seguro de eliminar la meta?", function(){
        	...
        	$.post("../controlador/compromiso.php?op=eliminarmeta", {id_meta : id_meta}, function(e){
				if(e=='true'){
					alertify.success("Eliminado correctamente");
...
function validarCompromiso(id_compromiso)
{
	...
	alertify.confirm("validar compromiso","¿Está Seguro de validar el compromiso?", function(){
        	...
        	$.post("../controlador/compromiso.php?op=validarcompromiso", {id_compromiso : id_compromiso}, function(e){
