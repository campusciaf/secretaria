...
function listargeneral(){
	$("#precarga").show();
	$("#resultadoprofesional").hide();
	$.post("../controlador/renovacionfinanciera.php?op=listargeneral",{},function(data){
...
function listarestudiantes(periodo,valor){
	...
	var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
		...
		tabla=$('#tbllistado').dataTable(
		{
			...
			"ajax":
					{
						url: '../controlador/renovacionfinanciera.php?op=listarestudiantes&periodo='+periodo+'&valor='+valor,
						type : "get",
						dataType : "json",						
						error: function(e){
...
//Función ver estudiantes
function listarestudiantesporrenovar(periodo,valor){
	$("#precarga").show();
	var meses = new Array ("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
	var diasSemana = new Array("Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado");
	var f=new Date();
	var fecha_hoy=(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
		...
		tabla=$('#tbllistado').dataTable(
		{
			...
			"ajax":
					{
						url: '../controlador/renovacionfinanciera.php?op=listarestudiantesporrenovar&periodo='+periodo+'&valor='+valor,
						type : "get",
						dataType : "json",						
						error: function(e){
							console.log(e.responseText);	
		...
		tabla=$('#tbllistadoconfig').dataTable(
			{
				...
				"ajax":
						{
							url: '../controlador/renovacionfinanciera.php?op=configurar',
							type : "get",
							dataType : "json",						
							error: function(e){
								// console.log(e.responseText);	
	...
	function cambioestado(id_programa,estado){
		...
		$.post("../controlador/renovacionfinanciera.php?op=cambioestado",{id_programa:id_programa,estado:estado},function(data, status){
