...
function ListarFuncionarios(){
    var tabla_listar_funcionarios = $("#dtl_funcionarios_hoja_vida").DataTable({
        "aProcessing": true, 
        "aServerSide": true, 
        "dom": "Bfrtip",
        "buttons": [{
        ...
        "ajax": {
            "url": "../controlador/reporte_hoja_vida.php?op=listar_funcionarios",
            "type": "get",
            "dataType": "json",
    ...
    $("a.toggle-vis").on("click", function (e) { 
        var column = tabla_listar_funcionarios.column($(this).attr("data-column"));
