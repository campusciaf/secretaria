...
function init(){
	...
	$.post("../controlador/encuestatic.php?op=selectPeriodo", function(r){
...
function datospanel() {
    ...
    $.post("../controlador/encuestatic.php?op=datospanel",{periodobuscar:periodobuscar}, function(r){
        var data = JSON.parse(r);
        $("#datos").html(data);
    });
}
...
function resultados(id_docente) {
    ...
    $.post("../controlador/encuestatic.php?op=resultados",{id_docente:id_docente , periodobuscar:periodobuscar}, function(r){
        var data = JSON.parse(r);
...
function listar(){
    ...
    tabla = $('#tbllistado').dataTable({
		...
		"ajax":{
            "url": '../controlador/encuestatic.php?op=listar',
            "type" : "POST",
