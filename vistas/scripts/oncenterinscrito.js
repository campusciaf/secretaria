...
function iniciarTour() {
	introJs().setOptions({
		...
		steps: [
			{
				title: 'Inscrito',
				intro: "Bienvenido a nuestro módulo de seres creativos inscritos"
			},
			{
...
function iniciarSegundoTour() {
	introJs().setOptions({
		...
		},
		{
			...
			"intro": "Aquí encontrarás los diferentes programas a los que nuestros seres creativos han sido inscritos "
		},
		{
			"title": 'Ninguno',
		...
		},
		{
			...
			"intro": "Regresa el tiempo en nuestro campus y encontrarás nuevamente nuestro panel de inscritos"
		},
		]
	}).start();
}
...
function listar() {
	$("#precarga").show();
	$.post("../controlador/oncenterinscrito.php?op=listar", {}, function (data, status) {
		...
		$("#precarga").hide();
		$.post("../controlador/oncenterinscrito.php?op=selectPeriodo", {}, function (data, status) {
			data = JSON.parse(data);// convertir el mensaje a json
...
function listarDos(periodo) {
	...
	$("#precarga").show();
	$.post("../controlador/oncenterinscrito.php?op=listarDos", { periodo: periodo, }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
...
function listarTres(medio, periodo) {
	...
	$.post("../controlador/oncenterinscrito.php?op=listarTres", { medio: medio, periodo: periodo }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
		$(document).ready(function () {
			$('#tbllistado').DataTable({
				"paging": false,
	...
	tabla = $('#tbllistadoestudiantes').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantes&nombre_programa=' + nombre_programa + '&jornada=' + jornada + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
	...
	tabla = $('#tbllistadoestudiantes').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantesMedio&nombre_programa=' + nombre_programa + '&jornada=' + jornada + '&medio=' + medio + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantessuma').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantesSuma&jornada=' + jornada + '&estado=' + estado + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantes').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantesSumaMedio&jornada=' + jornada + '&medio=' + medio + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantestotal').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantesTotal&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
	...
	tabla = $('#tbllistadoestudiantesmedio').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verEstudiantesTotalMedio&medio=' + medio + '&periodo=' + periodo,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
...
function verHistorial(id_estudiante) {
	$("#precarga").show();
	$.post("../controlador/oncenterinscrito.php?op=verHistorial", { id_estudiante: id_estudiante }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
...
function agregar(id_estudiante) {
	...
	$.post("../controlador/oncenterinscrito.php?op=agregar", { id_estudiante: id_estudiante }, function (data, status) {
		data = JSON.parse(data);// convertir el mensaje a json
	...
	tabla = $('#tbllistadohistorial').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verHistorialTabla&id_estudiante=' + id_estudiante,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
	...
	tabla = $('#tbllistadoHistorialTareas').dataTable(
		{
			...
			"ajax":
			{
				url: '../controlador/oncenterinscrito.php?op=verHistorialTablaTareas&id_estudiante=' + id_estudiante,
				type: "get",
				dataType: "json",
				error: function (e) {
					console.log(e.responseText);
...
function selectModalidadCampana() {
	...
	$.post("../controlador/oncenterinscrito.php?op=selectModalidadCampana", function (r) {
...
function guardarCambioDocumento(e3) {
	...
	if (nuevo_documento == repetir_documento) {
		$.ajax({
			url: "../controlador/oncenterinscrito.php?op=verificarDocumento&nuevodocumento=" + nuevo_documento,
			type: "POST",
			data: formData,
			contentType: false,
			processData: false,
...
function selectEstado() {
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinscrito.php?op=selectEstado", function (r) {
		$("#estado").html(r);
...
function guardarMoverUsuario(e4) {
	...
	$.ajax({
		url: "../controlador/oncenterinscrito.php?op=moverUsuario",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
function eliminar(id_estudiante, fila) {
	alertify.confirm('Eliminar Caso', '¿Está Seguro de eliminar el Caso?', function () {
		$.post("../controlador/oncenterinscrito.php?op=eliminar", { id_estudiante: id_estudiante }, function (e) {
			if (e == 1) {
...
function selectPrograma() {
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinscrito.php?op=selectPrograma", function (r) {
		$("#fo_programa").html(r);
...
function selectJornada() {
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinscrito.php?op=selectJornada", function (r) {
		$("#jornada_e").html(r);
...
function selectTipoDocumento() {
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinscrito.php?op=selectTipoDocumento", function (r) {
...
function selectNivelEscolaridad() {
	//Cargamos los items de los selects
	$.post("../controlador/oncenterinscrito.php?op=selectNivelEscolaridad", function (r) {
...
function perfilEstudiante(id_estudiante, identificacion, fila) {
	...
	$("#fila").val(fila);
	$.post("../controlador/oncenterinscrito.php?op=perfilEstudiante", { id_estudiante: id_estudiante }, function (data, status) {
...
function editarPerfil(e5) {
	...
	$.ajax({
		url: "../controlador/oncenterinscrito.php?op=editarPerfil",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
function verEntrevista(id_estudiante) {
	$.post("../controlador/oncenterinscrito.php?op=verEntrevista", { id_estudiante: id_estudiante }, function (data) {
		data = JSON.parse(data);
		$("#padre").val(data.padre);
		$("#madre").val(data.madre);
		$("#sostiene").val(data.sostiene);
		$("#dedicacion_papa").val(data.dedicacion_papa);
		$("#dedicacion_mama").val(data.dedicacion_mama);
		$("#labora").val(data.labora);
		$("#salario").val(data.salario);
		$("#donde_labora").val(data.donde_labora);
		$("#hermanos").val(data.hermanos);
		$("#motiva").val(data.motiva);
		$("#conoce_plan").val(data.conoce_plan);
		$("#otro_programa").val(data.otro_programa);
		$("#cual_programa").val(data.cual_programa);
