...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    $submenu = 3903;
    require 'header.php';
    require '../controlador/hv_fun_info_usuario.php';
?>
                ...
                <div class="row mb-2">
                    <div class="col-6">
                        <h2 class="m-0 line-height-16">
                            <span class="titulo-2 fs-18 text-semibold" id="nombre_programa">Hoja de vida única funcionario</span><br>
                                    ...
                                    <div style="padding: 2% 1%">
                                        <div class="box-body box-form-cv">
                                            <div class="box-header with-border">
                                                <h3 class="box-title" id="pasos_hoja_vida"> </h3>
                                            </div>
                                            <div class="row">
                                                <!-- MENU -->
                                                <div class="col">
                                                ...
                                                <!-- paso para los datos personales paso 1 -->
                                                <div class="col-12 col-sm-12 col-md-9 tono-2 px-4 pt-4" id="form1">
                                                    <div class="col-12">
                                                        <h6 class="title">Información personal </h6>
                                                    </div>
                                                    <form method="POST" name="funcionarios_informacion_personal_form" id="funcionarios_informacion_personal_form">
                                                        <div class="row">
                                                            <div class="col-md-6" hidden>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="hv_fun_id_informacion_personal" id="hv_fun_id_informacion_personal" value="<?= $info_usuario['hv_fun_id_informacion_personal'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <input type="text" class="form-control border-start-0" name="nombres" id="nombres" maxlength="50" placeholder="Nombre Completo" required="" value="<?= $info_usuario['cvadministrativos_nombre'] ?>">
                                                                        <label>Nombres(*):</label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <input type="text" class="form-control border-start-0" name="apellidos" id="apellidos" placeholder="Apellidos" required="" value="<?= $info_usuario['usuario_apellido'] ?>">
                                                                ...
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <select class="form-control border-start-0" name="estado_civil" id="estado_civil">
                                                                            <option value="" disabled <?= empty($info_usuario["estado_civil"]) ? "selected" : "" ?>>Selecciona una opción</option>
                                                                            <option value="SOLTERO/A" <?= ($info_usuario["estado_civil"] == "SOLTERO/A") ? "selected" : "" ?>>Soltero/a</option>
                                                                            <option value="UNIÓN LIBRE" <?= ($info_usuario["estado_civil"] == "UNIÓN LIBRE") ? "selected" : "" ?>>Unión Libre</option>
                                                                            <option value="CASADO/A" <?= ($info_usuario["estado_civil"] == "CASADO/A") ? "selected" : "" ?>>Casado/a</option>
                                                                            <option value="SEPARADO/A" <?= ($info_usuario["estado_civil"] == "SEPARADO/A") ? "selected" : "" ?>>Separado/a</option>
                                                                            <option value="DIVORCIADO/A" <?= ($info_usuario["estado_civil"] == "DIVORCIADO/A") ? "selected" : "" ?>>Judicialmente divorciado/a</option>
                                                                            <option value="VIUDO/A" <?= ($info_usuario["estado_civil"] == "VIUDO/A") ? "selected" : "" ?>>Viudo/a</option>
                                                                        </select>
                                                            ...
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <select required class="form-control border-start-0" data-live-search="true" name="categoria_profesion" id="categoria_profesion">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="experiencia_docente" id="experiencia_docente_si" value="1"
                                                                            ...
                                                                            onchange="ActualizarEstadoExperienciaDocente(this.value, '<?php echo $id_cvadministrativos; ?>', 'Experiencia Docente')">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="politicamente_expuesta" id="politicamente_expuesta_si" value="1"
                                                                            ...
                                                                            onchange="ActualizarEstadoPoliticamenteExpuesto(this.value, '<?php echo $id_cvadministrativos; ?>', 'Políticamente expuesta')">
                                                ...
                                                <div id="popoverLaboral" class="popover-laboral tono-1 borde rounded p-2" style="display:none; position:absolute; z-index:1055; width:90%; max-width:600px;">
                                                    <form id="form-experiencia_laboral" name="form-experiencia_laboral" class="p-3 m-0 rounded shadow tono-2" style="width: 100%;" method="POST">
                                                        ...
                                                        <div class="col-12">
                                                            <h6 class="title">Tu experiencia laboral</h6>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                ...
                                                <!-- paso para las Habilidades y Aptitude paso 4-->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12" style="margin-top: 40px;">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        ...
                                                                        <div class="col-12 mt-3 text-end" id="btnSiguiente_habilidadesyaptitudes" style="display: none;">
                                                                            <button class="btn btn-primary btn-sm" onclick="avanzarAlSiguientePaso()">Continuar</button>
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                ...
                                                <!-- paso para las referencias personales paso 5-->
                                                    ...
                                                    <form id="form-referencias_personales" name="form-referencias_personales" class="p-3 m-0 rounded shadow tono-2" style="width: 100%;" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <!-- <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <select value="" required class="form-control border-start-0" data-live-search="true" name="parentesco" id="parentesco">
                                                            ...
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        <select required class="form-control border-start-0 selectpicker" data-live-search="true" name="parentesco_referencia_personal" id="parentesco_referencia_personal">
                                                                            <option value="" disabled selected> --Parentesco-- </option>
                                                                            <?php
                                                                            $parentescos = [
                                                                                "Padre",
                                                                            ...
                                                                            foreach ($parentescos as $p) :
                                                                            ?>
                                                                                <option value="<?php echo $p; ?>" <?php echo ($info_usuario['parentesco_referencia_personal'] == $p) ? "selected" : ""; ?>>
                                                                                    <?php echo $p; ?>
                                                                                </option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                ...
                                                <!-- paso para las referencias laborales paso 6-->
                                                            ...
                                                            <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                                                                <div class="form-group mb-3 position-relative check-valid">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="referencias_nombrel">Jefe inmediato</label>
                                                                    </div>
                                                                </div>
                                                                <div class="invalid-feedback">Please provide a valid name</div>
                                                            </div>
                                                ...
                                                <!-- paso para los documentos obligatorios paso 7-->
                                                ...
                                                <!-- pasos para los documentos adicionales paso 8-->
                                                ...
                                                <!-- paso para las areas de conocimient paso 9-->
    ...
    <div class="modal" id="modal-documentos_obligatorios" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Documento Obligatorio</h5>
                ...
                <div class="modal-body">
                    <form method="POST" name="form-documentos_obligatorios" id="form-documentos_obligatorios">
                        <input type="hidden" id="id_cvadministrativos_documento_obligatorio" name="id_cvadministrativos_documento_obligatorio">
                        ...
                        <button type="submit" class="btn btn-success guardarDatos btn-block mt-4">Guardar</button>
                    </form>
                </div>
    ...
    <!-- Modal Persona Políticamente Expuesta -->
    <div id="popoverFormularioPoliticamenteExpuesto" class="popover-PoliticamenteExpuesto tono-1 borde rounded p-2" style="display:none; position:absolute; z-index:1055; width:90%; max-width:600px;">
        <div class="p-3 m-0 rounded shadow tono-2" style="width: 100%;">
            <div style="text-align: right;">
                <button type="button" onclick="cerrarPopoverPoliticamenteExpuesto()" class="btn btn-sm btn-link" aria-label="Cerrar">
                    <i class="fa-solid fa-xmark"></i>
                </button>
            </div>
            <div class="col-12">
                <h6 class="title">Persona Políticamente Expuesta (PEP)</h6>
            </div>
            se entiende justamente como alguien que ocupa o ha ocupado funciones públicas destacadas, en un país u organismo internacional.
            <br><br>
            Esto incluye, entre otros:
            <ul>
                <li>Jefes de Estado o de Gobierno</li>
                <li>Altos funcionarios de gobierno</li>
                <li>Altos mandos militares</li>
                <li>Miembros de la judicatura o tribunales superiores</li>
                <li>Directivos de empresas estatales</li>
            </ul>
        </div>
    </div>
...
ob_end_flush();
?>
<script src="scripts/hv_fun_panel.js"></script>
<script src="scripts/hv_fun_informacion-personal.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
</body>
