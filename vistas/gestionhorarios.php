...
?>
               ...
               <div class="row mb-2">
                  <div class="col-xl-6 col-9">
                     <h2 class="m-0 line-height-16">
                        <span class="titulo-2 fs-18 text-semibold">Gestión horarios</span><br>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-10">
                                    <div class="row">
                                       ...
                                       <div class="col-12">
                                          <a class="btn btn-xs pointer text-warning" title="Agregar al horario"> <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Publicar</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-10">
                                    <div class="row">
                                       ...
                                       <div class="col-12 fs-12"><i class="fa-solid fa-caret-right" aria-hidden="true"></i> Martes 01:00 am a 04:30 am - P-304 - c:1</div>
                                       <button class="btn btn-link text-warning btn-xs" title="Agregar al horario"> <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Publicar</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-12 borde-bottom-2 pt-2"></div>
                           <div class="col-12 p-2" id="t-card5">
                              <div class="row">
                                 <div class="col-2 text-center ">
                                    <span class="badge badge-primary">Sede</span>
                                    <figure class="pt-1">
   ...
   require 'footer.php';
   ?>
   <script type="text/javascript" src="scripts/gestionhorarios.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
ob_end_flush();
?>
