...
<div class="content-wrapper">
         ...
         <div class="row mb-2">
            <div class="col-6">
               <h2 class="m-0 line-height-16">
                     <span class="titulo-2 fs-18 text-semibold">No interesados</span><br>
                     <span class="fs-16 f-montserrat-regular">Gestione los clientes que no han podido ser parte de la transformación CIAF</span>
               </h2>
            </div>
            ...
            <div class="col-12 migas">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active">No interesados</li>
                  </ol>
            </div>
   ...
   <section class="content p-4">
         ...
         <div class="row" id="resultadoDos"></div>
...
<script type="text/javascript" src="scripts/oncenternointeresados.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
