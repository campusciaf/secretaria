          ...
          <div class="row mb-2">
              <div class="col-xl-6 col-9">
                <h2 class="m-0 line-height-16">
                      <span class="titulo-2 fs-18 text-semibold">Docente</span><br>
                ...
                <div class="col-xl-12">
                    ...
                    <form action="#" method="post" class="row" id="form_consulta_filtrada">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3 col-6">
                            <div class="form-group  position-relative check-valid">
                                <div class="form-floating">
                                  <select name="contrato" id="contrato" class="form-control border-start-0 selectpicker" multiple data-live-search="true" onchange="buscar()">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3 col-6">
                            <div class="form-group  position-relative check-valid">
                                <div class="form-floating">
                                  <select name="nivel_formacion" id="nivel_formacion" class="form-control border-start-0 selectpicker" multiple data-live-search="true" onchange="buscar()">
                                  </select>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3 col-6 d-none">
                            <div class="form-group  position-relative check-valid">
                                <div class="form-floating">
...
<script type="text/javascript" src="scripts/factordocente.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
	ob_end_flush();
?>
