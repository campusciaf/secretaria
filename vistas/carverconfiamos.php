...
<div class="content-wrapper ">
          ...
          <div class="row mb-2">
              ...
              <div class="col-12 migas">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Confiamos</li>
                    </ol>
              </div>
          </div>
        </div>
   ...
   <section class="container-fluid px-4 mb-4">
    ...
    require 'footer.php';
    ?>
    <script type="text/javascript" src="scripts/carverconfiamos.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
ob_end_flush();
?>