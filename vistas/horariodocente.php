        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <h2 class="m-0 line-height-16">
                        <span class="titulo-2 fs-18 text-semibold">Horario por docente</span><br>
                        <span class="fs-14 f-montserrat-regular">Visualice los horarios de clases por docente activo.</span>
                </h2>
                </div>
                ...
                <div class="col-12 migas mb-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Horario por docente</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-6" id="t-programa">
                                <div class="form-group mb-3 position-relative check-valid">
                                    ...
                                    <select value="" required name="id_docente" id="id_docente" class="form-control border-start-0 selectpicker" data-live-search="true" onChange="buscarDatos()"></select>
                                    <label>Docente</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-6" id="t-periodo">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="form-floating">
                    ...
                    <div class="col-12 tono-3 p-4" id="titulo">
                        <div class="row ">
                            ...
                            <div class="col-4 tono-3 text-right">
                                <button class="btn bg-orange pointer text-white" id="btn_print" onclick="printCalendar()"> <i class="fas fa-print"></i> Imprimir </button>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="scripts/horariodocente.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>