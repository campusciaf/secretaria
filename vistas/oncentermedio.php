         ...
         <div class="row mb-2">
            <div class="col-sm-6">
               <h2 class="m-0 line-height-16">
                     <span class="titulo-2 fs-18 text-semibold">Medios</span><br>
                     <span class="fs-16 f-montserrat-regular"> Descubra el medio de llegada de los clientes</span>
               </h2>
            </div>
                  ...
                  <div class="col-6 p-4 tono-3">
                           <div class="row align-items-center">
                              ...
                              <div class="col-5 fs-14 line-height-18"> 
                                 ...
                                 <span class="text-semibold fs-20">Medios</span> 
                              </div> 
                              </div>
                           </div>
                     </div>
                     ...
                     <div class="col-6 py-4 pr-4 text-right tono-3">
                        <button id="t-Am" class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Medio</button>
                     </div>
   ...
   <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="modal-header">
            <h6 class="modal-title">Medios</h6>
         ...
         <div class="modal-body">
            <div class="panel-body p-3" id="formularioregistros">
               <form name="formulario" id="formulario" method="POST">
                  ...
                  <input type="hidden" name="id_medio" id="id_medio">
...
<script type="text/javascript" src="scripts/oncentermedio.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
	ob_end_flush();
?>