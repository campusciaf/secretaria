        ...
        <div class="contenido">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h5>CONTRATO DE TRABAJO TERMINO FIJO</h5>
                </div>
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        Entre los suscritos a saber, de una parte,<strong> JAIRO RODRÍGUEZ VALDERRAMA</strong>, mayor de edad, identificado con cédula de ciudadanía Nº 79.291.743 expedida en Bogotá, actuando en calidad de representante legal de <strong>CORPORACIÓN INSTITUTO DE ADMINISTRACIÓN Y FINANZAS – CIAF-,</strong> con domicilio principal en la ciudad de Pereira, identificada con NIT. 891.408.248-5, quien en adelante se denominará <strong>EL EMPLEADOR</strong> y <u><?php echo $nombre_completo; ?></u>, mayor de edad, identificado con cédula de
                        ciudadanía número <u><?php echo $documento_docente; ?></u>, quien en adelante se denominará <strong>EL TRABAJADOR</strong>, acuerdan celebrar el presente <strong>CONTRATO DE TRABAJO TERMINO FIJO- MEDIA JORNADA </strong> que se regirá por las
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    ...
                    <ol>
                        ...
                        <li>Todas las demás obligaciones señaladas en el Artículo 58 del C.S.T.</li>
                    </ol>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>QUINTA.- REMUNERACION:</strong> La remuneración de EL TRABAJADOR será la suma mensual de
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>SÉPTIMA. - JORNADA DE TRABAJO</strong>EL TRABAJADOR se obliga a laborar la jornada de Medio Tiempo, salvo estipulación expresa y escrita en contrario, en los turnos y dentro de las horas señalados por La Corporación, pudiendo hacer éste los ajustes o cambios de horario cuando lo estime conveniente. Por el acuerdo expreso o tácito de las partes, podrán repartirse las horas de la jornada ordinaria en la forma prevista en la ley, teniendo en cuenta que los tiempos de descanso entre las secciones de la jornada no se computan dentro de la misma.
                        <strong><u>PARÁGRAFO SEGUNDO:</u></strong> De acuerdo a lo establecido en la Ley 2101 de 2021, se estableció la reducción de la jornada laboral semanal de manera gradual, por lo que a partir del día 15 de julio de 2024, se reducirá una (1) hora de la jornada laboral semanal, quedando la jornada semanal en cuarenta y seis (46) horas semanales, es decir, veintitrés horas (23) horas medio tiempo.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>DÉCIMA. - PERIODO DE PRUEBA:</strong> Se considera como período de prueba la quinta parte del término inicialmente pactado para el presente contrato, el cual bajo ninguna circunstancia podrá exceder de dos meses. Por consiguiente, cualquiera de las partes podrá terminar el contrato unilateralmente en cualquier momento durante dicho período, sin que se cause el pago de indemnización alguna.
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>UNDÉCIMA. -DURACION DEL CONTRATO:</strong> El presente contrato tendrá un término fijo contado a partir del día <?php echo htmlspecialchars($dia_inicio); ?> de <?php echo htmlspecialchars($mes_inicio_texto); ?> del <?php echo $contrato_docente->convertirAnioALetrasSimple($anio_inicio); ?> (<?php echo htmlspecialchars($anio_inicio); ?>), hasta el día <?php echo htmlspecialchars($dia_final); ?> de <?php echo htmlspecialchars($mes_final_texto); ?> del <?php echo $contrato_docente->convertirAnioALetrasSimple($anio_final); ?> (<?php echo htmlspecialchars($anio_final); ?>),
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <ol>
                        ...
                        <li>12. Presentarse al sitio de trabajo asignado, alterado por estado de embriaguez o bajo la influencia de narcóticos u otras sustancias que afecten su buen desempeño. </li>
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>DECIMA TERCERA. - CONCILIACIÓN:</strong> Las partes manifiestan expresamente que las diferencias que surjan entre EL EMPLEADOR y EL TRABAJADOR, en razón del desarrollo y ejecución de este contrato, se someterán en primera medida a conciliación previa entre las partes y de acuerdo a lo estipulado en el reglamento interno de trabajo.
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>DECIMA CUARTA. - MODIFICACION DE LAS CONDICIONES LABORALES:</strong> EL TRABAJADOR acepta desde ahora expresamente todas las modificaciones determinadas por EL EMPLEADOR, en ejercicio de su poder subordinante, de sus condiciones laborales, tales como la jornada de trabajo, el lugar de prestación de servicio, el cargo u oficio y/o funciones y la forma de remuneración, siempre que tales modificaciones no afecten su honor, dignidad o sus derechos mínimos ni impliquen desmejoras sustanciales o graves perjuicios para él, de conformidad con lo dispuesto por el Art.23 del C.S.T., modificado por el Art.1o. de la Ley 50/90. Los gastos que se originen con el traslado de lugar de prestación del servicio serán cubiertos por EL EMPLEADOR de conformidad con el numeral 8o. del Art.57 del C.S.T.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>VIGESIMA: - AUTORIZACIÓN DE NOTIFICACIÓN:</strong> En virtud del presente contrato, EL TRABAJADOR autoriza a EL EMPLEADOR a realizar cualquier notificación relacionada con la relación laboral a través del correo electrónico proporcionado.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row" style="display: flex; justify-content: space-between; align-items: flex-start;">
                ...
                <div style="width: 45%; text-align: left;">
                    <p class="mt-3">
                        ...
                        <strong><span><?php echo $nombre_completo; ?></span><br>
