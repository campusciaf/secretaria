         ...
         <div class="row mb-2">
            <div class="col-sm-6">
               <h2 class="m-0 line-height-16">
                     <span class="titulo-2 fs-18 text-semibold">Programas</span><br>
                     <span class="fs-16 f-montserrat-regular"> Gestiona los programas para ofrecer a los clientes</span>
               </h2>
            </div>
               ...
               <div class="col-12">
                  <div class="row">
                     ...
                     <div class="col-6 p-4 tono-3">
                        <div class="row align-items-center">
                           ...
                           <div class="col-5 fs-14 line-height-18"> 
                              ...
                              <span class="text-semibold fs-20">Programas</span> 
                           </div> 
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-6 py-4 pr-4 text-right tono-3" >
                        <button id="t-prom" class="btn btn-success" id="btnagregar" onclick="mostrarform(true)" ><i class="fa fa-plus-circle"></i> Agregar Programa</button>
                     </div>
   ...
   <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="modal-header">
            <h6 class="modal-title">Programa</h6>
...
<script type="text/javascript" src="scripts/oncenterprograma.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
	ob_end_flush();
?>