...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0"><small id="nombre_programa"></small>Crear compromisos <button class="btn btn-success btn-sm pull-right" id="btnagregar" title="Agregar Compromiso" onclick="mostrarform(true);numerocampo(<?php echo $_SESSION['id_eje'];?>)"><i class="fa fa-plus-circle"></i> Agregar Compromiso</button> </h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-xl-3 col-lg-6 col-md-6 col-12">
                           ...
                           <div class="input-group mb-3">
                              ...
                              <select id="compromiso_anio" name="compromiso_anio"  class="form-control selectpicker" data-live-search="true" required>
                              </select>
                           </div>
                        </div>
                        <div class="form-group col-xl-6 col-lg-12 col-md-12 col-12">
                           ...
                           <div class="input-group mb-3">
                              ...
                              <select id="resposable_compromiso" name="resposable_compromiso"  class="form-control selectpicker" data-live-search="true" required>
                              </select>
                           </div>
                        </div>
                        <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-xl-6 col-lg-6 col-md-6 col-6">
                        ...
                        <div class="input-group mb-3">
                           ...
                           <input type="text" name="meta_periodo" id="meta_periodo" class="form-control" readonly>	
...
<script type="text/javascript" src="scripts/saccrearcompromiso.js"></script>
