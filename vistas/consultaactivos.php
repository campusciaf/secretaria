      ...
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-xl-6 col-9">
               ...
               <span class="titulo-2 fs-18 text-semibold">Activos</span><br>
               <span class="fs-14 f-montserrat-regular">Vista que contiene los estudiantes activos del periodo actual</span>
               </h2>
            </div>
...
<script type="text/javascript" src="scripts/consultaactivos.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
