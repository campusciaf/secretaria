...
<!--Contenido-->
      ...
      <div class="content-wrapper">        
              ...
              <div class="col-md-12">
				...
				<div class="btn-group alert col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<div style="text-align: right">
						...
						<i class="fas fa-database"></i> Admin Bases de Datos</a>
					</div>
				</div>
				<style>
					a:hover{
		...
		<div class="row" style="margin:10px 0px; padding:0px">
			<button class="btn btn-success" id="btnAbrirModalBaseDatos"><i class="fas fa-database"> Agregar Base de Datos</i>
		</div>
...
<!-- Modal (Agregar, Modificar, Borrar Bases de Datos)-->
<div class="modal fade" id="modalBasesDeDatos" tabindex="-1" role="dialog" aria-labelledby="modalBasesDeDatos" aria-hidden="true">
 <form method="POST" id="form_bd">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <b><h3 class="modal-title" id="tituloModalBaseDatos">Agregar Base de Datos</h3></b>
      </div>
      <div class="modal-body">
        <div class="form-row">
        	<input type="hidden" id="id_base_datos" name="id_base_datos"/>
        	<div class="form-group col-md-6">
        		<label>Logo Base de Datos:</label>
