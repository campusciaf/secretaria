    ...
    <div class="container">
        <div class="contenido">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        ...
                        escrita que documente el consentimiento por parte del titular del dato personal. <strong><u>PARÁGRAFO TERCERO:</u></strong><strong> USO DE LA IMAGEN:</strong> EL TRABAJADOR autoriza a EL EMPLEADOR para hacer uso y tratamiento de su derecho de imagen para incluirlos sobre fotografías, procedimientos análogos a la fotografía, producciones audiovisuales y todos aquellos conexos que tengan que ver con el derecho de imagen en medio electrónico, magnético, óptico, en redes, mensaje de datos o similares. Sin limitación geográfica o territorial alguna en vigencia o no del presente contrato para uso institucional, comercial o mercadeo que beneficie a la institución.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>VIGESIMA: - AUTORIZACIÓN DE NOTIFICACIÓN:</strong> En virtud del presente contrato EL TRABAJADOR autoriza a EL EMPLEADOR a realizar cualquier notificación relacionada con la relación laboral a través del correo electrónico institucional que se le proporcionará AL TRABAJADOR y/o al correo personal <?php echo htmlspecialchars($usuario_email_p); ?>.
                    </p>
                </div>
            </div>
            <div class="row">
