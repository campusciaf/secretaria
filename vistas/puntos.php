        ...
        <div class="content-header">
                ...
                <div class="row mb-2 mx-0">
                    <div class="col-xl-6 col-9">
                        <h2 class="m-0 line-height-16">
                            <span class="titulo-2 fs-18 text-semibold">Gráficas de Puntos estudiantes</span><br>
            ...
            <div class="col-12 migas mb-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Gráficas de puntos estudiante</li>
                    </ol>
            </div>
            </div>
...
<script type="text/javascript" src="scripts/puntos.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
