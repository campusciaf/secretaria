...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0"><small id="nombre_programa"></small> Arquitectura Institucional <span id="volver"><a onclick="volver()" class="btn btn-info">Volver</a></span></h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="panel.php">Inicio</a></li>
                  <li class="breadcrumb-item active">Gestión arquitectura</li>
               </ol>
            </div>
            <!-- /.col -->
         </div>
      ...
      <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card card-primary" style="padding: 2% 1%">
               <div class="row">
                  <div id="tllistado" style="padding: 1%; overflow: auto"></div>
                  <div id="compromiso" style="padding: 1%; overflow: auto"></div>
               </div>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                           ...
                           <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" name="compromiso_nombre" id="compromiso_nombre" maxlength="255" placeholder="Nombre del Compromiso" onchange="javascript:this.value=this.value.toUpperCase();" required>
                           </div>
                        </div>
                        <!--
                        ...
                        <div class="form-group col-xl-3 col-lg-3 col-md-12 col-12">
                           ...
                           <div class="input-group mb-3">
                              ...
                              <select id="compromiso_valida" name="compromiso_valida"  class="form-control selectpicker" data-live-search="true" required></select>
                           </div>
                        </div>
                        <div class="form-group col-xl-3 col-lg-3 col-md-12 col-12 ">
...
<div id="myModalImprimir" class="modal fade" role="dialog">
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
            ...
            <table width="100%">
               <tr>
                  <td>
                     ...
                     <b>Fecha de Impresión:</b> <?php echo $arquitectura->fechaesp($fecha); ?>
                  </td>
                  <td align="right">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal" onClick="cerrar()">Close</button>
         </div>
      </div>
   </div>
</div>
...
<script type="text/javascript" src="scripts/arquitectura.js"></script>
