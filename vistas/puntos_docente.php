        ...
        <div class="content-header">
                ...
                <div class="row mb-2 mx-0">
                    <div class="col-xl-6 col-9">
                        <h2 class="m-0 line-height-16">
                            <span class="titulo-2 fs-18 text-semibold">Gráficas de Puntos docentes</span><br>
            ...
            <div class="col-12 migas mb-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Gráficas de puntos Docente</li>
                    </ol>
            </div>
            </div>
  ...
  <div class="col-xl-3 col-lg-6 col-md-6 col-12 card py-2">
    <div class="">
      <div class="row align-items-center">
        ...
        <div class="col">
          <p class="small  mb-0">Total de puntos otorgados</p>
...
<script type="text/javascript" src="scripts/puntos_docente.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
