...
?>
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Seleccionado</span><br>
                                <span class="fs-16 f-montserrat-regular">Gestione la documentación de los clientes para ser parte de la transformación CIAF</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Seleccionados</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content p-4">
                <div class="row">
                    ...
                    <div class="row" id="listadoregistrostres">
                        ...
                        <div class="col-lg-6 tono-3 py-3"><a onClick="volverDos()" class="btn btn-danger float-right"><i class="fas fa-arrow-circle-left"></i> Volver</a></div>
        ...
        <div id="myModalDocumentos" class="modal fade" role="dialog">
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/oncenterseleccionado.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
