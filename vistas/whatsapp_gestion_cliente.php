...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    $submenu = 3605;
    require 'header.php';
    if ($_SESSION['whatsapp_gestion_cliente'] == 1) {
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card m-0">
                            <div class="row no-gutters">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 listado_chats" style="height: 75vh; overflow: auto">
                                    ...
                                    <div class="users-container p-0" style="margin-top: -10px;">
...
ob_end_flush();
?>
<script src="scripts/whatsapp_gestion_cliente.js?<?= date("Y-m-d-h-i-s-h") ?>"></script>
<script src="scripts/whatsapp_module.js?<?= date("Y-m-d-h-i-s-h") ?>"></script>