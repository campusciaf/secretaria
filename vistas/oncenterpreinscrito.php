...
?>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Preinscrito</span><br>
                                <span class="fs-16 f-montserrat-regular">Seguimos avanzando con el inicio de los seres originales</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Preinscrito</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
            ...
            <section class="content p-4">
                <div class="row col-12" id="resultado"></div>
                <div class="row col-12" id="resultadoDos"></div>
                <div class="row" id="listadoregistrostres">
                    ...
                    <div class="card p-4 panel-body table-responsive">
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/oncenterpreinscrito.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
