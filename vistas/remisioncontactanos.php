...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    if ($_SESSION['remisioncontactanos'] == 1) {
?>
                    ...
                    <div class="row mb-2">
                        <div class="col-xl-8 col-lg-7 col-md-8 col-9">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Remisiones Académicas y Administrativas </span><br>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Remisiones Académicas y Administrativas </li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row align-items-center pt-2">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-12 col-3">
                                        <div class="fs-14 line-height-18">
                                            ...
                                            <span class="text-semibold fs-16 parrafo-normal">Remisiones</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="scripts/remisioncontactanos.js"></script>
