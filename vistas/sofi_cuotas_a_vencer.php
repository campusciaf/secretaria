                    ...
                    <div class="row mb-2">
                        <div class="col-xl-8 col-9">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Cuotas a vencer</span><br>
                                <span class="fs-14 f-montserrat-regular">Espacio donde se visualizan los estudiantes que estan próximos para pago de cuota</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Cuotas a vencer</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="row">
                    <div class="col-12 pb-2">
                        <button class="btn btn-outline-success btn-xs" data-toggle="modal" data-target="#agregarSeguimientoTodos"> <i class="fas fa-plus"></i> Seguimiento </button>
                    </div>
                    <div class="col-md-12">
                        <div class="card card-primary" style="padding: 2% 1%">
                            <div class="panel-body ">
                                <div class="row" id="tablaregistros">
                                    <div class="col-sm-12">
                                        <table id="tabla_cuotas_a_vencer" class="table table table-hover">
                                            <thead>
                                                <th>Acciones</th>
                                                <th>Nombres</th>
                                                <th>Apellidos</th>
...
ob_end_flush();
?>
<script src="scripts/sofi_cuotas_a_vencer.js?<?= date("Y-m-d H:i:s") ?>"></script>
