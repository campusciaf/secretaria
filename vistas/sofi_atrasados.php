...
?>
					...
					<div class="row mb-2">
						<div class="col-xl-8 col-9">
							<h2 class="m-0 line-height-16">
								<span class="titulo-2 fs-18 text-semibold">Cuotas Atrasadas</span><br>
								<span class="fs-14 f-montserrat-regular">Espacio donde se visualizan los estudiantes que se encuentran en situación de cartera vencida por periodo</span>
							</h2>
						</div>
						...
						<div class="col-12 migas">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Cuotas Atrasadas x Periodo</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card card-primary" style="padding: 2% 1%">
							<select class="form-control" name="periodo" id="periodo" onchange="listar_atrasados(this.value)">
							</select>
	...
	require 'footer.php';
	?>
	<script src="scripts/sofi_atrasados.js?<?= date("y-m-d") ?>"></script>
