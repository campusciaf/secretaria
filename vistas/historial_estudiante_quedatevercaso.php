                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane card" id="tab_2">
                                                ...
                                                <div class="card-body box-profile-mat" aria-expanded="true" id="datos_estudiante">
                                                    <div class="row box-profile">
                                                        <div class="col-md-4 text-center">
                                                            <img class="profile-user-img img-responsive img-circle img_estudiante" style="height: 100px;" src="../files/null.jpg" alt="User profile picture">
                                                            <h3 class="nombre_estudiante box-profiledates text-center">Nombre del Estudiante</h3>
                                                            <p class="text-muted apellido_estudiante box-profiledates text-center"> ---------------- </p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <br>
                    ...
                    <div class="modal-body">
                        <form method="POST" id="form_remision">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select_dependencia" name="dependencia" data-style="border" data-live-search="true" required>
                    ...
                    <div class="modal-body">
                        <form id="form_cerrar" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control mb-3" id="categorias_cerrado" name="categoria_cerrar" required></select>
                            </div>
...
<script src="scripts/historial_estudiante_quedatevercaso.js?<?=date("y-m-d")?>"></script>