        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><small id="nombre_programa"></small>Horario Especial</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="panel.php">Inicio</a></li>
                                <li class="breadcrumb-item active">Horario Especial</li>
                            </ol>
                        </div>
                    </div>
                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!-- Modal matricular_asignatura especial-->
        <div class="modal fade" id="myModalDocenteCualquiera" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Docentes Disponibles</h4>
                    ...
                    <div class="modal-body">
                        <form name="formulariohomologacion" id="formulariohomologacion" method="POST">
                            ...
                            <div class="form-group col-12">
                                <div class="input-group">
                                    <!-- <input type="hiddend" name="materia_docentes_cualquiera" id="materia_docentes_cualquiera"> -->
                                    <div id="selecionar_docente_cualquiera"> </div>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <!-- Modal matricular_asignatura especial-->
        <div class="modal fade" id="ModalEditarDocente" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form name="formularioeditardocente" id="formularioeditardocente" method="POST">
                            <div class="form-group col-12">
                                <div class="input-group">
                                    <div id="editar_docente_cualquiera"> </div>
                                </div>
                            </div>
                        </form>
                    </div>
...
ob_end_flush();
?>
<script type="text/javascript" src="scripts/horario_especial.js"></script>