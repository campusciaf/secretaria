...
<div class="content-wrapper">
         ...
         <div class="row mb-2">
            <div class="col-sm-6">
               <h2 class="m-0 line-height-16">
                     <span class="titulo-2 fs-18 text-semibold">Asesores</span><br>
                     <span class="fs-16 f-montserrat-regular">Visualice el rendimiento de los asesores con el registro de los seguimientos</span>
               </h2>
            </div>
   ...
   <section class="content" style="padding-top: 0px;">
      <div class="row justify-content-center">
         ...
         <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-4" id="datosetiquetas">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/oncenterasesores.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
