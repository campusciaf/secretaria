...
?>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Administrador Noticias</span><br>
                                <span class="fs-16 f-montserrat-regular">Administra las noticias de la pagina web.</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Administrador Noticias</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-10">
                                                <div class="col-12 fs-14 line-height-18">
                                                    ...
                                                    <span class="text-semibold fs-20">Administrador Noticias</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 text-right py-4 pr-4 tono-3">
                                        <button class="btn btn-success pull-right" id="tour_agregar_noticia_video" onclick="mostraragregarvideo(true)"><i class="fa fa-plus-circle"></i> Agregar Noticia con Video</button>
                                        <button class="btn btn-success pull-right" id="tour_agregar_noticia_imagen" onclick="mostraragregarimagen(true)"><i class="fa fa-plus-circle"></i> Agregar Noticia con Imagen</button>
                                    </div>
                            ...
                            <form name="formularioeditarnoticias" id="formularioeditarnoticias" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" required="" class="form-control border-start-0" name="titulo_noticias" id="titulo_noticias" maxlength="100" required>
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" required="" class="form-control border-start-0" name="subtitulo_noticias" id="subtitulo_noticias" maxlength="100" required>
                                    ...
                                    <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <select value="" required class="form-control border-start-0 selectpicker" data-live-search="true" name="categoria_noticias" id="categoria_noticias">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <textarea type="text" placeholder="" value="" class="form-control border-start-0" style="height: 164px;" name="contenido_noticias_editar" id="contenido_noticias_editar" required></textarea>
                                ...
                                <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                                    <input type="number" class="d-none id_noticias" id="id_noticias" name="id_noticias">
            ...
            <div class="modal fade" id="ModalVideo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar Noticia Con Video</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <form name="formulariovideo" id="formulariovideo" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="titulo_noticias_video" id="titulo_noticias_video" required>
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="subtitulo_noticias_video" id="subtitulo_noticias_video" required>
                                                <label>Subtítulo</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                                        <div class="mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <select value="" required class="form-control border-start-0 selectpicker" data-live-search="true" name="categoria_noticias_video" id="categoria_noticias_video">
                                                    <label>Categoría</label>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <textarea type="text" placeholder="" value="" class="form-control border-start-0" style="height: 164px;" name="contenido_noticias_video" id="contenido_noticias_video" required></textarea>
                                                <label>Contenido</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                                    <input type="number" class="d-none id_noticias_video" id="id_noticias_video" name="id_noticias_video">
            ...
            <div class="modal fade" id="ModalImagen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar Noticia Con Imagen</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <form name="formularioagregarimagen" id="formularioagregarimagen" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="titulo_noticias_imagen" id="titulo_noticias_imagen" required>
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">                                
                                        <div class="form-floating">
                                            <input type="text" placeholder="" value="" class="form-control border-start-0" name="subtitulo_noticias_imagen" id="subtitulo_noticias_imagen" required>
                                            <label>Subtítulo</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                                        <div class="mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <select value="" required class="form-control border-start-0 selectpicker" data-live-search="true" name="categoria_noticias_imagen" id="categoria_noticias_imagen">
                                                    <label>Categoría</label>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <textarea type="text" placeholder="" value="" class="form-control border-start-0" style="height: 164px;" name="contenido_noticias_imagen" id="contenido_noticias_imagen" required></textarea>
                                                <label>Contenido</label>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript" src="scripts/web_noticias.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
