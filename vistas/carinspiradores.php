          ...
          <div class="row mb-2">
              <div class="col-xl-8 col-9">
                <h2 class="m-0 line-height-16">
                      <span class="titulo-2 fs-18 text-semibold">Inspiradores</span><br>
            ...
            <div class="col-12 tono-3 py-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-7 line-height-18">
                        ...
                        <span class="titulo-2 text-semibold fs-20 line-height-18">Inspiradores</span> 
                    </div>
                    <div class="col-3 bg-success"><span class="fs-24">Paso 2/6</span></div>
                </div>
            </div>
...
<script src="scripts/carinspiradores.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>