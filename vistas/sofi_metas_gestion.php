...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    $submenu = 2324;
	require 'header.php';
	if ($_SESSION['sofimetasgestion'] == 1) {
?>
		...
		<div class="content-wrapper ">
					...
					<div class="row mb-2">
						<div class="col-xl-8 col-9">
							<h2 class="m-0 line-height-16">
								<span class="titulo-2 fs-18 text-semibold">Metas de la campaña</span><br>
								<span class="fs-14 f-montserrat-regular">Control sobre las metas de cada asesor</span>
							</h2>
						</div>
						...
						<div class="col-12 migas">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Mi meta</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="row">
                    ...
                    <div class="col-xl-5 col-lg-4 col-md-4 col-12">
                        <div class="form-group mb-3 position-relative check-valid">
                            <div class="form-floating">
                                <select value="" required="" class="form-control border-start-0 selectpicker" data-live-search="true" name="colaboradores" id="colaboradores" onchange="listar(this.value)"></select>
					...
					<div class="col-8 py-3 pl-4" id="metaasesor"></div>
					<div class="col-4"  id="metaasesorpagos"></div>
					<div class="col-md-12">
						<div class="card card-primary" style="padding: 2% 1%">
							<table id="tabla_atrasados" class="table table-condensed table-hover table-responsive table-sm">
								<thead>
									<td>Opciones</td>
									<td>Crédito</td>
									<td>Etiqueta</td>
					...
					<div class="modal-body">
						<div class="container">
							<form class="row" action="#" method="POST" id="agregarMensajeTodos">
								<div class="col-12">
									<label for="mensaje_todos" class=""> Este mensaje se agregará a todos los estudiantes que no esten en cobro </label>
									<textarea class="form form-control" name="mensaje_todos" id="mensaje_todos" cols="30" rows="10"></textarea>
								</div>
	...
	<?php
        ...
        require 'footer.php';
	?>
	<script src="scripts/sofi_metas_gestion.js?<?= date("y-m-d") ?>"></script>
	...
	<script src="scripts/whatsapp_module.js?<?= date("y-m-d") ?>"></script>
<?php
}
ob_end_flush();
?>