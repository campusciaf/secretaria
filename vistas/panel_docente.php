            ...
            <div class="row mb-2">
                <div class="col-xl-6 col-9">
                    <h2 class="m-0 line-height-16 pl-4">
                        <span class="titulo-2 fs-18 text-semibold">Bienvenido</span><br>
                        <span class="fs-14 f-montserrat-regular">Al parche CIAF.</span><br>

                    </h2>
                </div>
                <div class="modal fade" id="modalFotoPerfil" tabindex="-1" role="dialog"
                    aria-labelledby="modalFotoPerfilLabel" aria-hidden="true" data-backdrop="static"
                    data-keyboard="false">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalFotoPerfilLabel">¡Agrega tu foto de perfil!</h5>
                            </div>
                            <div class="modal-body text-center">
                                <p>Docente CIAF es importante identificarte, por eso te invitamos a subir tu foto de perfil para mejorar tu experiencia</p>
                            </div>
                            <div class="modal-footer">
                                <a href="configurarcuentadocente.php" class="btn btn-primary">Agregar foto de perfil</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contenido" id="mycontenido">
            <div class="row">
                            ...
                            <div class="row justify-content-center pt-4">
                                ...
                                <div class="col-2">
                                    <div class="rounded-circle bg-7 text-white p-3 line-height-18 text-center"
                                        style="width:70px"><span id="days" class="fs-28 titulo-7"></span> <br>días
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="rounded-circle bg-7 text-white p-3 line-height-18 text-center"
                                        style="width:70px"><span id="hours" class="fs-28 titulo-7"></span> <br>horas
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="rounded-circle bg-7 text-white p-3 line-height-18 text-center"
                                        style="width:70px"><span id="minutes" class="fs-28 titulo-7"></span> min. </div>
                                </div>
                                <div class="col-2">
                                    <div class="rounded-circle bg-7 text-white p-3 line-height-18 text-center"
                                        style="width:70px"><span id="seconds" class="fs-28 titulo-7"></span> seg. </div>
                                </div>
                ...
                <div class="col-xl-9 col-lg-3 col-md-3 col-12">
                    ...
                    <div class="col-12"><div id="slides-continuada"></div></div>

                </div>
                <!-- eduacion continuada -->
                <div class="col-xl-3 col-lg-3 col-md-3 col-12 mb-4 p-4" id="t-paso24">
...
<div id="myModalEncuesta" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Supera la Barreras</strong></h4>
            </div>
            <div class="modal-body">
                <div id="preguntas"></div>
                <form name="formulario" id="formulario" method="POST">
                    <div class="alert alert-success">
                        <h4> Autoevaluación Institucional</h4>
                    </div>
                    <label>¿Hago uso óptimo del campus virtual CIAFi?</label>
                    <select name="r1" id="r1" class="form-control" required>
                    ...
                    <label>¿Hago uso eficiente de las tecnologías de la información en el desarrollo de mis clases?
                        Como, por ejemplo: caja de herramientas, e- libro.</label>
                    <select name="r2" id="r2" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Apoyo el plan de permanencia del estudiante con comunicación oportuna de inasistencias u
                        observaciones especiales </label>
                    <select name="r3" id="r3" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Conozco y aplico los reglamentos que intervienen en mi labor</label>
                    <select name="r4" id="r4" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Participo activamente en las actividades académicas programadas por la institución.</label>
                    <select name="r5" id="r5" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Participo activamente en las actividades administrativas, deportivas y culturales programadas
                        por la institución.</label>
                    <select name="r6" id="r6" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Comunico oportunamente los ajustes realizados a las clases, tanto a las direcciones de
                        escuela como a los estudiantes</label>
                    <select name="r7" id="r7" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>Demuestro dominio en mi área o disciplina</label>
                    <select name="r8" id="r8" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>¿Doy cumplimiento al acuerdo de labor firmado?</label>
                    <select name="r9" id="r9" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <label>¿Muestro compromiso y entusiasmo en las actividades para docentes?</label>
                    <select name="r10" id="r10" class="form-control" required>
                        <option value="">Seleccionar</option>
                        <option value="3">Siempre</option>
                        <option value="2">Casi siempre</option>
                        <option value="1">A veces</option>
                    ...
                    <br><br>
                    <button class="btn btn-danger btn-block" type="submit" id="btnGuardar"><i class="fa fa-save"></i>
                        Clic aquí para Enviar Respuestas</button>
                </form>
            </div>
            <div class="modal-footer">
            </div>
...
<!-- Modal para preguntas al inicio del panel del docente-->
<div id="encuestatic" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Diagnóstico de Competencias TIC</strong></h4>
            </div>
            <div class="modal-body">
                <div id="preguntas"></div>
                <form name="formulario-encuesta" id="formulario-encuesta" method="POST">
                    <div id="avancepregunta"></div>
                    <div id="pregunta"></div>
                    <div class="form-group">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="ep1" name="er1" value="1" required>
                            <label for="ep1" class="custom-control-label">Si</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="ep1-2" name="er1" value="0">
                            <label for="ep1-2" class="custom-control-label">No</label>
                        </div>
                    </div>
                    <button class="btn btn-danger btn-block" type="submit" id="btnGuardarpregunta"><i
                            class="fa fa-save"></i> Clic aquí para Enviar Respuestas</button>
                </form>
            </div>
            <div class="modal-footer">
            </div>
...
<div class="modal fade" id="modalPreguntas" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="modalmonitoreandoDocente" tabindex="-1" role="dialog"
    aria-labelledby="modalmonitoreandoDocente" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <form method="POST" name="form-monitoreando-docente" id="form-monitoreando-docente">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-row mt-3">
                        ...
                        <div class="likert">
                            <label>CIAF dispone de canales de comunicación para que los estudiantes manifiesten sus
                                inquietudes y sugerencias y se responden de manera satid¡sfactoria y oportuna.
                            </label><br>
...
<!-- <script type="text/javascript" src='../fullcalendar/js/main.js'></script> -->
<!-- <script type="text/javascript" src='../fullcalendar/locales/es.js'></script> -->
<script type="text/javascript" src="scripts/panel_docente.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<!-- <script type="text/javascript" src="../public/js/educacion-continuada.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script> -->
<!-- <script type="text/javascript" src='../public/js/sly.min.js'></script> -->
<!-- fullCalendar -->
<!-- <script src="../bower_components/moment/moment.js"></script>
<script src="../bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
<script src="../bower_components/fullcalendar/dist/locale/es.js"></script> -->
<!-- Script para cargar los eventos js del calendario -->
<!-- <script src="scripts/admincalendario.js"></script> -->
