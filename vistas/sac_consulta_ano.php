...
if (!isset($_SESSION["usuario_nombre"])) {
    ...
    $submenu = 218;
    require 'header.php';
    if ($_SESSION['sac_consulta_ano'] == 1) {
?>
                    ...
                    <div class="row mb-2">
                        <div class="col-xl-8 col-lg-7 col-md-8 col-9">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">POA por año</span><br>
                                <span class="fs-16 f-montserrat-regular">Consulte las acciones por año de su POA</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Consulta Poa Año</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center pt-2">
                            ...
                            <div class="col">
                                <div class="fs-14 line-height-18">
                                    ...
                                    <span class="text-semibold fs-16 titulo-2 fs-16 line-height-16" id="dato_periodo">Poa Año</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form name="formulario" id="formulario" method="POST" class="row">
                            <div class="col-12 p-0 m-0" id="tour_buscar">
                                <div class="form-floating col-12">
                                    <select value="" required class="form-control border-start-0 selectpicker" data-live-search="true" name="fecha_ano" id="fecha_ano" onchange="buscar(fecha_ano.value)">
    ...
    require 'footer.php';
    ?>
    <script type="text/javascript" src="scripts/sac_consulta_ano.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
