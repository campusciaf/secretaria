        ...
        <div class="contenido">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    ...
                    <ol>
                        <li>Cumplir con la labor académica asignada para dictar <?php echo $contrato_docente->numero_a_letras($cantidad_horas); ?> <?php echo $cantidad_horas; ?> horas de la catedra de <?php echo htmlspecialchars($materia_docente); ?> que se distribuyen en Cinco (5) días por semana. </li>
                        <li>Organizar un ambiente estructurado y estimulador del aprendizaje</li>
                        <li>Adecuar estrategias de enseñanza para el aprendizaje de acuerdo a la metodología requerida por CIAF. </li>
                        <li>Evaluar los aprendizajes de acuerdo a la metodología que se proponga</li>
                        <li>Realizar la planeación, definición y ejecución de las actividades, para lo cual de garantizar lo que inspira la Institución en su pensamiento institucional, el propósito superior, la misión, la visión y los principios rectores de CIAF, en cumplimiento de las condiciones de calidad exigidas por las normas nacionales, situando a nuestros estudiantes en centro de nuestro actuar y a los docentes como guías del proceso de aprendizaje en cuanto a:</li>
                        <ul>
                            <li>Matrículas nuevas: Definir estrategias y garantizar el cumplimiento de las metas de grupos nuevos, homologaciones y reintegros, definidas por la Rectoría. </li>
                            <li>Permanencia: Definir estrategias y garantizar el cumplimiento de las metas de renovación de matrícula, definidas por la Rectoría.</li>
                            <div class="salto-linea"></div>
                            <li>Extensión universitaria: Definir oferta académica con los responsables de los programas académicos para cumplir las metas definidas por la Rectoría. Esta oferta académica debe buscar satisfacer las necesidades y el relacionamiento con las organizaciones, el Estado y las personas.</li>
                            <li>El desarrollo de los programas académicos y la educación continuada son herramientas para el relacionamiento con el sector externo y para que los estudiantes y docentes compartan experiencias en contextos reales. El desarrollo de estas actividades deben ser un insumo permanente para evaluar y mejorar toda la oferta académica de la institución.</li>
                            <li>Investigaciones: Debe contribuir a la reclasificación del grupo de investigaciones de acuerdo al plan estratégico, de tal manera que cada programa tenga una línea de investigación pertinente en concordancia con la política de investigación. La investigación y la experiencia en la oferta académica, debe tener como propósito la construcción de estrategias y alianzas, que permitan a la Institución, docentes y estudiantes, participar en la solución de los retos de las organizaciones, el Estado y las personas. Los temas de la investigación formativa deben garantizar la pertinencia del programa, el pensamiento institucional y el impacto significativo en la sociedad</li>
                            <li>Fortalecimiento de la oferta académica: Deben dirigir las estrategias para garantizar la renovación de los programas académicos, su pertinencia, los contenidos, sus modalidades y la creación de nuevos programas que faciliten el acceso de las personas a la educación superior y a la formación para el trabajo y desarrollo humano. </li>
                            <li>Bienestar y egresados: Se debe trabajar conjuntamente con el bienestar y egresados para la definición de las estrategias y ejecución de las políticas de estas áreas para que el estudiante viva las mejores experiencias en la Institución.</li>
                            <li>Producir y comunicar: En la era digital, es necesario que todo lo que producimos en la Institución, la sociedad lo sepa con el fin de alcanzar nuestra Visión.</li>
                        </ul>
                        <li>Adecuar estrategias de enseñanza para el aprendizaje. Cumplir con el horario de Trabajo definido por la Corporación.</li>
                        <li>Cumplir con el horario de trabajo asignado. </li>
                        ...
                        <li>Mantener su hoja de vida actualizada con los documentos necesarios en la plataforma “Campus Virtual”. </li>
                        ...
                        <li>Todas las demás consagradas en el Artículo 58 del C.S.T. </li>
                    </ol>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>SEXTA.- REMUNERACION:</strong> La remuneración mensual de EL TRABAJADOR, se calculan por la hora catedra dictada, para lo cual se establecen,<strong> <?php echo $contrato_docente->numero_a_letras($cantidad_horas); ?> (<?php echo $cantidad_horas; ?>)</strong> horas, a un valor de <strong><?php echo $contrato_docente->numero_a_letras($valor_horas); ?> pesos m/cte. ($<?php echo $valor_horas; ?>)</strong> cada hora, valor que incluye prestaciones sociales y seguridad social, por el número de horas efectivamente dictadas en el mes.
                        <strong><u>PARÁGRAFO PRIMERO:</u></strong> Los valores que resulten a su favor, serán liquidados y pagados en la respectiva cuenta bancaria que para tal fin indique EL TRABAJADOR.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>OCTAVA. - JORNADA DE TRABAJO:</strong> EL TRABAJADOR, se obliga a laborar las horas catedra que sean previamente acordadas y autorizadas por <strong>CORPORACIÓN INSTITUTO DE ADMINISTRACIÓN Y FINANZAS –CIAF.</strong>
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>DUODÉCIMA. - DURACION DEL CONTRATO:</strong> El presente contrato tendrá un término fijo contado a partir del día <?php echo $contrato_docente->numero_a_letras($dia_inicio); ?> (<?php echo htmlspecialchars($dia_inicio); ?>) de <?php echo htmlspecialchars($mes_inicio_texto); ?> del <?php echo $contrato_docente->convertirAnioALetrasSimple($anio_inicio); ?> (<?php echo htmlspecialchars($anio_inicio); ?>), hasta el día <?php echo $contrato_docente->numero_a_letras($dia_final); ?> (<?php echo htmlspecialchars($dia_final); ?>) de <?php echo htmlspecialchars($mes_final_texto); ?> del <?php echo $contrato_docente->convertirAnioALetrasSimple($anio_final); ?> (<?php echo htmlspecialchars($anio_final); ?>),
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: justify;">
                    <p>
                        <strong>DÉCIMA TERCERA. - TERMINACION UNILATERAL:</strong> El presente contrato se podrá terminar unilateralmente y sin indemnización alguna, por cualquiera de las partes, siempre y cuando se configure algunas de las situaciones previstas en el artículo 62 del Código Sustantivo del Trabajo o haya incumplimiento grave de alguna cláusula prevista en el contrato de trabajo o por el incumplimiento al reglamento de trabajo, manual de funciones, circulares, directrices, procedimientos y demás instrucciones que EL EMPLEADOR, haya establecido a cargo de EL TRABAJADOR .
                        Expresamente se califican en este acto, como faltas graves, por parte de EL TRABAJADOR, las siguientes:
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row pb-0">
                <div class="col-xs-12 pb-0" style="text-align: justify;">
                    <p class="pb-0 mb-0">
                        <strong>VIGESIMA PRIMERA: - AUTORIZACIÓN DE NOTIFICACIÓN:</strong> En virtud del presente contrato EL TRABAJADOR autoriza a EL EMPLEADOR a realizar cualquier notificación relacionada con la relación laboral a través del correo electrónico institucional que se le proporcionará AL TRABAJADOR y/o al correo personal <?php echo htmlspecialchars($usuario_email_p); ?>.
                    </p>
                </div>
            </div>
            <!-- <div class="salto-linea"></div> -->
            ...
            <div class="row" style="display: flex; justify-content: space-between; align-items: flex-start;">
                <div style="width: 45%; text-align: left;">
                    <p class="mt-1">
                        <strong style="display: block; margin-bottom: 50px;">EL EMPLEADOR</strong><br>
                ...
                <div style="width: 45%; text-align: left;">
                    <p class="mt-1">
                        <strong style="display: block; margin-bottom: 50px;">EL TRABAJADOR</strong><br>
                        <strong><span><?php echo mb_strtoupper($nombre_completo, 'UTF-8'); ?></span><br>
                            C.C. N°. <span><?php echo $documento_docente; ?> </span></strong>
                    </p>
                </div>
            </div>
            <div style="width: 100%; border: 1px solid black; border-collapse: collapse; display: table; margin-top: -10px">
