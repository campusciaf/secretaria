...
?>
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <h2 class="m-0 line-height-16">
                                <span class="titulo-2 fs-18 text-semibold">Mi Blog</span><br>
                                <span class="fs-16 f-montserrat-regular">Administra tus blogs.</span>
                            </h2>
                        </div>
                        ...
                        <div class="col-12 migas">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Mi Blog</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-10">
                                                <div class="col-12 fs-14 line-height-18">
                                                    ...
                                                    <span class="text-semibold fs-20">Mi Blog</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form name="formularioeditarnoticias" id="formularioeditarnoticias" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value=""  class="form-control border-start-0" name="titulo_blog" id="titulo_blog" maxlength="100" >
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value=""  class="form-control border-start-0" name="subtitulo_blog" id="subtitulo_blog" maxlength="100" >
                                    ...
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <select value=""  class="form-control border-start-0 selectpicker" data-live-search="true" name="categoria_blog" id="categoria_blog">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value=""  class="form-control border-start-0" name="link_noticia_imagen_editar" id="link_noticia_imagen_editar" maxlength="100" >
                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <textarea type="text" placeholder="" value="" class="form-control border-start-0" style="height: 164px;" name="contenido_blog_editar" id="contenido_blog_editar" ></textarea>
                                            </div>
                                        </div>
                            ...
                            <form name="formulariovideo" id="formulariovideo" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="titulo_blog_video" id="titulo_blog_video" >
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="subtitulo_blog_video" id="subtitulo_blog_video" >
                                                <label>Subtítulo</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" maxlength="100" name="url_video" id="url_video" >
                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <textarea type="text" placeholder="" value="" class="form-control border-start-0" style="height: 164px;" name="contenido_blog_video" id="contenido_blog_video" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" maxlength="100" name="link_noticia_video" id="link_noticia_video" >
                                ...
                                <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12">
                                    <input type="number" class="d-nonse id_blog_video" id="id_blog_video" name="id_blog_video">
                                    <input type="text" class="d-nones" name="editarvideoguardarconvideo" id="editarvideoguardarconvideo">
                                    <button class="btn btn-success btn-block" type="submit" id="btnGuardar"><i class="fa fa-save"></i> Guardar</button>
                                </div>
                            </form>
                            <div class="modal-footer">
                            ...
                            <form name="formularioagregarimagen" id="formularioagregarimagen" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="titulo_blog_imagen" id="titulo_blog_imagen" >
                                                <label>Título</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-floating">
                                            <input type="text" placeholder="" value="" class="form-control border-start-0" name="subtitulo_blog_imagen" id="subtitulo_blog_imagen" >
                                            <label>Subtítulo</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="form-group col-12">
                                            <div class="form-floating">
                                                <input type="text" placeholder="" value="" class="form-control border-start-0" name="link_noticia_imagen" id="link_noticia_imagen" >
    ...
    <script type="text/javascript" src="scripts/mi_blog.js?<?php echo date("Y-m-d-H:i:s"); ?>"></script>
<?php
}
ob_end_flush();
?>