...
Class CarVerSeresoriginales
{
	...
	public function listar(){	
		$sql="SELECT * FROM carseresoriginales";
		global $mbd;
	...
	public function listar2($valor){	
		$sql="SELECT * FROM carseresoriginales cro INNER JOIN estudiantes est ON cro.id_credencial=est.id_credencial  WHERE est.escuela_ciaf= :valor";
		global $mbd;
		$consulta = $mbd->prepare($sql);
