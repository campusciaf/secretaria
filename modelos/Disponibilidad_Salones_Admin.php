...
class Reserva
{
    ...
    //Implementar un método para mirar datos del docente
    public function colaborador_datos($id_usuario)
    {
...
//    public function aggReserva($id_docente, $horario, $hora_f, $salon, $descripcion, $fecha_reserva, $nombre_docente, $correo_docente, $telefono_docente, $programa, $programa_otro, $asistentes, $asistentes_otro, $materia_evento, $experiencia_nombre, $experiencia_objetivo, $duracion_horas, $lugar, $lugar_otro, $requerimientos, $requerimientos_otro, $novedad)
// {
//     global $mbd;
//     $tipo_user = ($_SESSION['usuario_cargo'] == "Docente") ? "d" : "f";
//     $periodo = $_SESSION['periodo_actual'];
...
//     $sentencia = $mbd->prepare("INSERT INTO `reservas_salones`(tipo_usuario,`id_docente`,`horario`,`salon`,`periodo`,`detalle_reserva`,`fecha_solicitud`,`fecha_reserva`,`estado`,`hora_f`,`nombre_docente`,`correo_docente`,`telefono_docente`,`programa`,`programa_otro`,`asistentes`,`asistentes_otro`,`materia_evento`,`experiencia_nombre`,`experiencia_objetivo`,`duracion_horas`,`lugar`,`lugar_otro`,`requerimientos`,`requerimientos_otro`,`novedad`) VALUES (:tipo_usu,:id_docente,:horario,:salon,:periodo,:detalle,:fecha_soli,:fecha_reserva,:estado,:hora,:nombre_docente,:correo_docente,:telefono_docente,:programa,:programa_otro,:asistentes,:asistentes_otro,:materia_evento,:experiencia_nombre,:experiencia_objetivo,:duracion_horas,:lugar,:lugar_otro,:requerimientos,:requerimientos_otro,:novedad)");
...
//     $sentencia->bindParam(":lugar_otro", $lugar_otro);
//     $sentencia->bindParam(":requerimientos", $requerimientos);
//     $sentencia->bindParam(":requerimientos_otro", $requerimientos_otro);
//     $sentencia->bindParam(":novedad", $novedad);
