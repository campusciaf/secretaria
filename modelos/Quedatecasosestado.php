 ...
 public function buscar($val,$ano)
{
    ...
    public function nombre_usuario($id)
    {
        ...
        return isset($registro['nombre']) ? $registro['nombre'] : "";
    }
