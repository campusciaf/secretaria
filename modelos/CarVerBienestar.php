...
Class CarVerbienestar
{
	...
	public function listar2($valor){	
		$sql="SELECT * FROM carbienestar cro INNER JOIN estudiantes est ON cro.id_credencial=est.id_credencial  WHERE est.escuela_ciaf= :valor";
		global $mbd;
		$consulta = $mbd->prepare($sql);
