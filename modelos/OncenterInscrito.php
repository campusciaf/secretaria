...
class OncenterInscrito{
	...
	{
		$sql = "UPDATE on_interesados SET identificacion= :nuevodocumento, nombre_modalidad= :modalidad_campana, estado='Inscrito', segui='1' WHERE id_estudiante= :id_estudiante_documento";
		global $mbd;
		$consulta = $mbd->prepare($sql);
		$consulta->bindParam(":nuevodocumento", $nuevodocumento);
