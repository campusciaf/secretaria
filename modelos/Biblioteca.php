...
Class Biblioteca
{
	...
	public function agregarLibro($url,$titulo,$fechaLanz,$autor,$categoria,$programa,$editorial,$isbn,$idioma,$paginas,$formato,$descripcion,$palabclave,$ejemplares){
		$sql_agregar = "INSERT INTO biblioteca VALUES(NULL, :url, :titulo, :fechaLanz, :autor, :categoria, :programa, :editorial, :isbn, :idioma, :paginas, :formato, :descripcion, :palabclave, :ejemplares)";
		global $mbd;
