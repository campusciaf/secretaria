...
class OncenterSeleccionado{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verCedula($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verDiploma($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verActa($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verSalud($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verPrueba($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de un registro a modificar
	public function verCompromiso($id_estudiante)
	{
	...
	//Implementar un método para mostrar los datos de proteccion de datos
	public function verProteccion($id_estudiante)
	{
...
{
    $sql = "SELECT * FROM on_seguimiento WHERE periodo_campana = :periodo AND mensaje_seguimiento = 'Seleccionado'";
    global $mbd;
    $consulta = $mbd->prepare($sql);
    $consulta->bindParam(":periodo", $periodo);
    $consulta->execute();
