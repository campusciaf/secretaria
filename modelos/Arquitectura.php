...
Class Arquitectura
{
	...
	public function __construct()
	{
		...
		//Implementar un método para mostrar las dependencias
	public function buscardependencias($jerarquia)
	{
		$sql="SELECT * FROM usuario WHERE usuario_poa=1 and jerarquia= :jerarquia ORDER BY orden ASC";
		global $mbd;
		$consulta = $mbd->prepare($sql);
		$consulta->bindParam(":jerarquia", $jerarquia);
		$consulta->execute();
	...
	{
		$sql="UPDATE compromiso SET id_usuario='$id_usuario', compromiso_nombre='$compromiso_nombre', compromiso_fecha='$compromiso_fecha', compromiso_val_admin='$compromiso_val_admin', compromiso_val_usuario='$compromiso_val_usuario',compromiso_valida='$compromiso_valida', compromiso_periodo='$compromiso_periodo' WHERE id_compromiso='$id_compromiso'";
		global $mbd;
		$consulta = $mbd->prepare($sql);
		return $consulta->execute();
	}
	...
	{
		$sql="INSERT INTO meta (id_compromiso,id_eje,meta_nombre,meta_fecha,meta_val_admin,meta_val_usuario,meta_valida,meta_periodo,corresponsabilidad)
		VALUES ('$id_compromiso_meta','$id_eje','$meta_nombre','$meta_fecha','$meta_val_admin','$meta_val_usuario','$meta_valida','$meta_periodo','$corresponsabilidad')";
//		global $mbd;
//		$consulta = $mbd->prepare($sql);
//		return $consulta->execute();
...
//Implementar un método para validar el compromiso
	...
	//Implementar un método para listar los condiciones institucionales
	public function listarCondicionesInstitucionales()
	{
		...
		//Implementar un método para listar condiciones programa
	public function listarCondicionesPrograma()
	{
		...
		//Implementar un método para listar las condiciones institucionales marcadas
