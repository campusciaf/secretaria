...
Class Mi_Blog
{
	...
	public function mostrar_noticias_por_usuario($id_usuario)
	{

		global $mbd;
		$sql = "SELECT * FROM web_blog WHERE `web_blog`.`id_usuario` = :id_usuario";
	...
	public function editarnoticias($url_video,$blog_img,$titulo_blog,$subtitulo_blog,$contenido_blog, $id_blog, $link_blog){
	...
	//Implementamos un método para editar el permiso del docente
	public function editarnoticiasimagen($blog_img,$titulo_blog,$subtitulo_blog,$contenido_blog, $id_blog, $link_blog){
	...
	public function desactivar_noticia($id_blog)
	{
