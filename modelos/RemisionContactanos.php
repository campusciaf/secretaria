...
//		return $consulta;
	...
	{	
		...
		$sql="SELECT * FROM ayuda_respuesta ar INNER JOIN ayuda ay ON ar.id_ayuda=ay.id_ayuda WHERE id_remite_a='".$id_usuario."' and periodo_respuesta= :periodo_actual";
		global $mbd;
		$consulta = $mbd->prepare($sql);
	...
	// {	
	// 	$sql="SELECT id_usuario,usuario_cargo,ayuda FROM usuario WHERE ayuda=0";
