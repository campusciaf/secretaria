...
class OncenterValEntrevista{
	...
	{
		$sql = "SELECT * FROM on_interesados WHERE estado='Inscrito' and periodo_campana= :periodo_actual";
	...
	function getBarraProgreso($porcentaje) {
		if ($porcentaje === null || $porcentaje === '') return '';
