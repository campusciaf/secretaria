...
Class CrearCompromiso
{
	...
	//Implementar un método para listar los compromisos
	public function listarCompromiso($periodo_actual)
	{	
		$sql="SELECT * FROM compromiso WHERE id_usuario='".$_SESSION['id_usuario']."' and compromiso_periodo='$periodo_actual'";
		global $mbd;
		$consulta = $mbd->prepare($sql);
		$consulta->execute();
		$resultado = $consulta->fetchAll();
