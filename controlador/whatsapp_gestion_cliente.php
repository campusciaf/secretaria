...
require_once "../modelos/WhatsappGestionCliente.php";
$consulta = new WhatsappGestionCliente();
...
switch ($_GET['op']) {
    case 'listarChats':
        ...
        for ($i = 0; $i < count($chats); $i++) {
            ...
            $estado_seguimiento = $consulta->EstadoSeguimiento($numero_whatsapp);
            $estado_conversacion = ($estado_seguimiento)?'Finalizado':'Activo';
            if($estado_seguimiento){
                ...
                $url = (file_exists($url)) ? "../files/estudiantes/" . $identificacion . ".jpg" : 'https://ciaf.digital/files/null.jpg';
                $text_success = "";
                ...
                <div class="container pointer" onclick="seleccionarChat(this,' . $numero_whatsapp . ')" data-chat="' . $numero_whatsapp . '">
                    ...
                    <img class="img_whatsapp_user" src="' . $url . '" alt="Imagen estudiante" />
                        <div class="col-8 mt-2">
                            ...
                            <br>  
                            <div style="height:12px" class="overflow-hidden small ultimo_mensaje_' . $numero_whatsapp . '">' . json_decode('"' . $ultimo_mensaje . '"') . '</div>
                        </div>
                        <div class="time col "> 
