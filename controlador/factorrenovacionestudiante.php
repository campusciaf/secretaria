<?php 
require_once "../modelos/FactorRenovacionEstudiante.php";
$consulta = new FactorRenovacionEstudiante();
...
switch ($_GET["op"]){
	...
	case 'general':
		...
		$datos=$consulta->total($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo consultado
		...
		$datosprofesionales=$consulta->soloprofesionales($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$datosprofesionalesanterior=$consulta->soloprofesionales($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$datoslaborales=$consulta->sololaborales($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$datoslaboralesanterior=$consulta->sololaborales($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$terminaronnivel=$consulta->terminaronnivel($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$terminaronnivelanterior=$consulta->terminaronnivel($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$terminaronterminal=$consulta->terminaronterminal($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$terminaronterminalanterior=$consulta->terminaronterminal($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$norenovo=$consulta->norenovo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// los que no renovaron que debian renovar;
		//$norenovoanterior=$consulta->norenovo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$norenovohomo=$consulta->norenovohomo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// los que no renovaron que debian renovar;
		$sirenovaronhomo=$consulta->sirenovohomo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$datoshomoanterior=$consulta->homologados($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;

		$norenovointerno=$consulta->norenovointerno($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$sirenointerno=$consulta->sirenovointerno($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$datosinternoanterior=$consulta->internos($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;
		
		$norenovorema=$consulta->norenovorema($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$sirenovorema=$consulta->sirenovorema($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$datosrematriculaanterior=$consulta->rematricula($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;
        

		$norenovonuevo=$consulta->norenovonuevo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
		$sirenovonuevo=$consulta->sirenovonuevo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);

		$sirenovaron=$consulta->sirenovo($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);

		
	
		// $datosdebenrenovar=$consulta->debenrenovar($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$datosdebenrenovaranterior=$consulta->debenrenovar($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;
		//$datosdebenrenovardosp=$consulta->debenrenovar($dosperiodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// los que deben renovar dos periodos antes

		//$datosnuevos=$consulta->nuevos($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		$datosnuevosanterior=$consulta->nuevos($periodoantes,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;
		
		//$datoshomo=$consulta->homologados($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		
		
		//$datosinterno=$consulta->internos($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		
		
		//$datosrematricula=$consulta->rematricula($periodo,$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo actual;
		
		
		$jornadarisaralda= "AND jornada_e IN ('R01')";
		$datosrisaralda=$consulta->porconvenios($periodo,$escuela_enviar,$nivel_enviar,$jornadarisaralda,$semestre_enviar,$programa_enviar);// activos convenios;
		$datosrisaraldaanterior=$consulta->porconvenios($periodoantes,$escuela_enviar,$nivel_enviar,$jornadarisaralda,$semestre_enviar,$programa_enviar);// activos convenios;

		$jornadasumale= "AND jornada_e IN ('A04', 'A03')";
		$datossumale=$consulta->porconvenios($periodo,$escuela_enviar,$nivel_enviar,$jornadasumale,$semestre_enviar,$programa_enviar);// activos convenios;
		$datossumaleanterior=$consulta->porconvenios($periodoantes,$escuela_enviar,$nivel_enviar,$jornadasumale,$semestre_enviar,$programa_enviar);// activos convenios;
		
		$jornadalau= "AND jornada_e IN ('A06','A06-1','A06-2','A06-3','DDAS')";
		$datoslau=$consulta->porconvenios($periodo,$escuela_enviar,$nivel_enviar,$jornadalau,$semestre_enviar,$programa_enviar);// activos convenios;
		$datoslauanterior=$consulta->porconvenios($periodoantes,$escuela_enviar,$nivel_enviar,$jornadalau,$semestre_enviar,$programa_enviar);// activos convenios;
		

		$jornadalaucuba= "AND jornada_e IN ('CAP')";
		$datoslaucuba=$consulta->porconvenios($periodo,$escuela_enviar,$nivel_enviar,$jornadalaucuba,$semestre_enviar,$programa_enviar);// activos convenios;
		$datoslaucubaanterior=$consulta->porconvenios($periodoantes,$escuela_enviar,$nivel_enviar,$jornadalaucuba,$semestre_enviar,$programa_enviar);// activos convenios;
		
		
		$jornadadirectos= "AND jornada_e IN ('D01','N01','F01','S01')";
		$datosdirectos=$consulta->porconvenios($periodo,$escuela_enviar,$nivel_enviar,$jornadadirectos,$semestre_enviar,$programa_enviar);// activos convenios;
		$datosdirectosanterior=$consulta->porconvenios($periodoantes,$escuela_enviar,$nivel_enviar,$jornadadirectos,$semestre_enviar,$programa_enviar);// activos convenios;
					...
					<div class="col-12 tono-3 py-3">
						<div class="row align-items-center pt-2">
							...
							<div class="col-xl-10 col-lg-10 col-md-10 col-10">
								...
								<span class="text-semibold fs-16 titulo-2 line-height-16">Renovación '. $periodo .'</span> 
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-xl-2 text-center bg-light-red align-items-center" 
								...
								<div class="row d-flex align-items-center h-100">
									<div class="col-12 ">
										<span class="text-secondary small">Cumplimiento</span>';
											if (count($datosdebenrenovaranterior) > 0) {
												$porcentajeSiRenovo = round((count($sirenovaron) / count($datosdebenrenovaranterior)) * 100);
											} else {
												$porcentajeSiRenovo = 0;
											}
										$data["dtotal"] .= '<h5>' . $porcentajeSiRenovo . '%</h5>
									</div>
								</div>
							</div>
		...
		/* formula para calcular los datos por convenio*/
			...
			for ($i=0;$i<10;$i++){
				$periodo_historico=$consulta->periodoanterior($id_periodo_actual);
				$periodo_comparado=$consulta->periodoanterior($id_periodo_comparado);

				$datoshistorico=$consulta->debenrenovar($periodo_historico["periodo"],$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);// consulta periodo anterior;
				$historiconorenovo=$consulta->norenovo($periodo_comparado["periodo"],$escuela_enviar,$nivel_enviar,$jornada_enviar,$semestre_enviar,$programa_enviar);
