<?php
require_once "../modelos/Claves.php";
session_start();
...
switch ($_GET['op']) {
    ...
    case 'listarClaves':
		 $rspta = $claves->listarClaves($id_usuario);
            ...
            $e = ($rspta[$i]['clave_estado'] == "1")? '<span class="label label-success">Activo</span>':'<span  class="label label-danger">Desactivado</span>';
 			...
 			$data[]=array(
                ...
                <button class="tooltip-agregar btn btn-warning btn-xs" onclick="mostrarplataforma(`'.$rspta[$i]['id_clave'].'`)" title="Editar Plataforma" data-toggle="tooltip" data-placement="top">
                 ...
                 <button onclick=eliminarPlataforma("'.$rspta[$i]['id_clave'].'") class="d-none btn btn-danger btn-xs"><i class="far fa-trash-alt"></i></button> '.$button,
    ...
    case 'agregar':
        ...
        $rspta=$claves->agregar($clave_plataforma, $clave_url, $clave_usuario, $clave_contrasena, $clave_descripcion, $clave_estado, $fecha, $hora, $id_usuario);
    ...
    case 'estado':
        ...
        $rspta=$claves->estado($id,$est,$fecha,$hora);
	...
	case 'mostrarplataforma':
		$rspta = $claves->mostrarplataforma($id_clave);
    ...
    case 'guardaryeditarplataforma':
		...
		$rspta = $claves->editarplataforma($id_clave,$clave_plataforma_m, $clave_url_m, $clave_usuario_m, $clave_contrasena_m, $clave_descripcion_m, $fecha, $hora, $id_usuario);
