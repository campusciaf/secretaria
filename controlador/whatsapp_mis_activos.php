...
require_once "../modelos/WhatsappMisActivos.php";
$consulta = new WhatsappMisActivos();
                ...
                <div class="container pointer" onclick="seleccionarChat(this,' . $numero_whatsapp . ')" data-chat="' . $numero_whatsapp . '">
                    ...
                    <img class="img_whatsapp_user" src="' . $url . '" alt="Imagen estudiante" />
                        <div class="col-8 mt-2">
                            ...
                            <br>  
                            <div style="height:36px" class="overflow-hidden small ultimo_mensaje_' . $numero_whatsapp . '">' . json_decode('"' . $ultimo_mensaje . '"') . '</div>
                        </div>
                        <div class="time col "> 
