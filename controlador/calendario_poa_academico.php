...
require_once "../modelos/CalendarioPoaAcademico.php";

$calendariopoaacademico = new CalendarioPoaAcademico();
...
switch ($op) {
	...
	case 'mostrarAcademica':
		...
		$consulta=$calendariopoaacademico->cargarCompromisosAcademicos();
		$reg = $consulta;
		$array = array();
		for ($i=0;$i<count($reg);$i++){
			$rsptadatos=$calendariopoaacademico->mostrarEventosAcademicos($id_usuario);
			$today = date("Y-m-d");
	...
	// 	$consulta=$calendariopoaacademico->cargaridUsuario($id_usuario);
	// 	// print_r($consulta);
	// 	$reg = $consulta;
	// 	$array = array();
	// 	for ($i=0;$i<count($reg);$i++){
	...
	// 		$rsptadatos = $calendariopoaacademico->mostrarEventosIndivual($id_usuario);
	// 		// print_r($rsptadatos);
	...
	case 'cargarUsuario':
		...
		$cargar_usuario = $calendariopoaacademico->cargarDatosUsuario($id_usuario);
		// print_r($cargar_usuario);
	...
	case 'cargarAccion':
		...
		$cargar_accion = $calendariopoaacademico->cargarAccion($id_proyecto);
		//Codificar el resultado utilizando Json
	...
	// 	$consulta=$calendariopoaacademico->cargarCompromisosAdministrativos();
	// 	$reg = $consulta;
	// 	$array = array();
	// 	for ($i=0;$i<count($reg);$i++){

	// 		$rsptadatos=$calendariopoaacademico->mostrarEventosAdministrativos($reg[$i]["id_compromiso"]);
	// 		$today = date("Y-m-d");
	// 		foreach($rsptadatos as $valor) {
	...
	// 	$consulta=$calendariopoaacademico->mostrarEventos();
	// 	// print_r($consulta);
	// 	//Codificar el resultado utilizando json
	// 	$array = array();
	// 	$today = date("Y-m-d");
