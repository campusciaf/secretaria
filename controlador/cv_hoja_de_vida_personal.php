<?php
    require_once "../modelos/CvHojaDeVidaPersonal.php";
    $informacionPersonal = new CvInformacionPersonal1();
    ...
    $id_usuario_cv = $_GET["uid"];
    $informacion_personal = $informacionPersonal->cv_getInfoHoja($id_usuario_cv);
    if($informacion_personal->rowCount() > 0){
        ...
        $info_usuario['id_usuario_cv'] = $id_usuario_cv; 
        $info_usuario['usuario_nombre'] = $usuario_nombre; 
        $info_usuario['usuario_apellido'] = $usuario_apellido; 
        $info_usuario['usuario_identificacion'] = $usuario_identificacion; 
        $info_usuario['usuario_email'] = $usuario_email; 
    ...
    $educacions_stmt = $informacionPersonal->cv_listareducacion($id_usuario_cv);
    ...
    $experiencias_stmt = $informacionPersonal->cv_listarExperienciasHoja($id_usuario_cv);
    ...
    $habilidad_stmt = $informacionPersonal->cv_listarHabilidad($id_usuario_cv);
    ...
    $referencias_stmt = $informacionPersonal->listarReferencias($id_usuario_cv);
    ...
    $referencias_stmt = $informacionPersonal->listarReferenciasL($id_usuario_cv);
    if($referencias_stmt->rowCount()>0){
    ...
    $documentosO_stmt = $informacionPersonal->listarDocumentosObligatorios($id_usuario_cv);
    ...
    $documentosA_stmt = $informacionPersonal->listarDocumentosAdicionales($id_usuario_cv);
