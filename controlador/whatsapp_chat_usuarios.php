...
require_once "../modelos/WhatsappChatUsuarios.php";
$consulta = new WhatsappChatUsuarios();
...
switch ($_GET['op']) {
    case 'listarChats':
        ...
        $chats = $consulta->listarChats($valor_a_buscar, $id_usuario);
        $total_sin_mostrar = $consulta->CantidadNoMostrados($id_usuario);
        ...
        $consulta->actualizarMostrados($id_usuario);
