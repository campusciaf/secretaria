...
$rspta_usuario = $usuario->cv_traerIdUsuario($_SESSION["usuario_identificacion"]);
...
switch ($_GET["op"]){
	case 'citar_entrevista':
        $rspta=$usuario->insertar_cita($nombre_usuario,$celular_usuario,$mi_correo_electronico,$correo_electronico,$direccion_entrevista,$fecha_entrevista,$hora_entrevista, $comentario_entrevista, $id_usuario_cv);
        if($rspta) {
