<?php
session_start();
require_once "../modelos/CaracterizacionDocente.php";

$caracterizaciondocente = new CaracterizacionDocente();
...
switch ($_GET['op']) {
    ...
    case 'aceptoData':
		$datos_acepto=$caracterizaciondocente->aceptoData($id_docente);
    ...
    case 'guardardata':
        ...
        $aceptodata=0;
        $rspta=$caracterizaciondocente->insertardata($id_docente,$aceptodata,$fecha);
        $rspta ? "1" : "2";
    ...
    case 'listarPreguntas':
        ...
        $pre=$caracterizaciondocente->listar($id_docente);
        ...
        $data["0"] .= '';
            $data["0"] .= '<div class="row">';
                ...
                $data["0"] .= '
                <div class="col-xl-3 col-lg-6 col-md-6 col-12" id="mostrar40">
                    <div class="form-group mb-3 position-relative check-valid">
                        <div class="form-floating">
                ...
                $data["0"] .= '<div class="col-12 p-4 text-right"><button type="submit" class="btn btn-success">Guardar datos</button></div>';
    ...
    case 'guardaryeditar':
		...
		$data["estado"] ="";
			...
			$rspta=$caracterizaciondocente->editarDatos($id_docente,$p1,$p2,$p3,$p4,$p5,$p6,$p7,$p8,$p9,$p10,$p11,$p12,$p13,$p14,$p15,$p16,$p17,$p18,$p19,$p20,$p21,$p22,$p23,$p24,$p25,$p26,$p27,$p28,$p29,$p30,$p31,$p32,$p33,$p34,$p35,$p36,$p37,$p38,$p39,$p40,$p41,$p42,$p43,$p44,$p45,$p46,$p47,$p48,$p49,$p50,$fecha);
			$datos=$rspta ? "si" : "no";	
