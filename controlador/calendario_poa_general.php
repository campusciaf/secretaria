...
require_once "../modelos/CalendarioPoaGeneral.php";

$calendariopoageneral = new CalendarioPoaGeneral();
...
switch ($op) {
	...
	case 'mostrar':
		...
		$consulta=$calendariopoageneral->mostrarEventos();
		// print_r($consulta);
	...
	case 'cargarUsuario':
		...
		$cargar_usuario = $calendariopoageneral->cargarDatosUsuario($id_usuario);
	...
	case 'cargarAccion':
		...
		$cargar_accion = $calendariopoageneral->cargarAccion($id_proyecto);
		//Codificar el resultado utilizando Json
	...
	// 	$consulta=$calendariopoageneral->cargarCompromisosAcademicos();
	// 	$reg = $consulta;
	// 	$array = array();
	// 	for ($i=0;$i<count($reg);$i++){
	// 		$rsptadatos=$calendariopoageneral->mostrarEventosAcademicos($reg[$i]["id_compromiso"]);
	// 		$today = date("Y-m-d");
	...
	// 	$consulta=$calendariopoageneral->cargarCompromisosAdministrativos();
	// 	$reg = $consulta;
	// 	$array = array();
	// 	for ($i=0;$i<count($reg);$i++){

	// 		$rsptadatos=$calendariopoageneral->mostrarEventosAdministrativos($reg[$i]["id_compromiso"]);
	// 		$today = date("Y-m-d");
	// 		foreach($rsptadatos as $valor) {
	...
	// 	$consulta=$calendariopoageneral->cargaridUsuario($id_usuario);
	// 	// print_r($consulta);
	// 	$reg = $consulta;
	// 	$array = array();
	// 	for ($i=0;$i<count($reg);$i++){
	...
	// 		$rsptadatos = $calendariopoageneral->mostrarEventosIndivual($id_usuario);
	// 		// print_r($rsptadatos);
